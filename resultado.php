...
$sinoDeal = $_POST['sinoDeal'];
$deal = $_POST['deal'];

$sinoPeex = $_POST['sinoPeex'];
$peex = $_POST['peex'];

$sinoMide = $_POST['sinoMide'];
$mide = $_POST['mide'];

$sinoArque = $_POST['sinoArque'];
$arque = $_POST['arque'];

$sinoEvn = $_POST['sinoEvn'];
$pimerNombreEnv = $_POST['pimerNombreEnv'];
$evn1 = $_POST['evn1'];
$segundoNombreEnv = $_POST['segundoNombreEnv'];
$evn2 = $_POST['evn2'];
...
$cuatri2 = $_POST['cuatri2'];
$cuatri3 = $_POST['cuatri3'];

$sinoInter = $_POST['sinoInter'];
...
$interAnual = $_POST['interAnual'];
    ...
    switch ($peex){
        ...
        case 2:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona que se muestra callada, modesta, pulcra, tranquila, pacifica, diplomática, cordial, equilibrada, dulce, encantadora, servicial, cooperativa, imaginativa, cariñosa, colaboradora. Das la imagen de una persona tímida, de baja estima, sumisa, susceptible e insegura.";
            break;

        case 3:
            echo 'Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es de simpática, sociable, optimista, creativa, espontánea, cordial, encantadora, divertida, artística, alegre, amigable, comunicadora, con gran facilidad para la palabra, entusiasta, atractiva, de buena figura, bella, atrayendo a los demás por tu personalidad. Te podes mostrar también dispersa, muy egocéntrica de querer llamar la atención, frontal, charlatana por demás, chismosa y novelera. La imagen que das es de habladora, casi charlatana con todo el mundo, con capacidad de hacer fácilmente amigos, sin embargo también hay algo de timidez que asoma.';
            break;

        case 4:
            echo 'Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona conservadora, disciplinada, práctica, ordenada, esforzada, muy respetuosa, constante, honrada, estructurada, seria, sensata, trabajadora, responsable, detallista, discreta, noble, tenaz, la mayoría de las veces transmitiendo seguridad y confianza. También podés mostrarte rigurosa, austera, fría, estricta, de poca habla, reacia, terca.';
            break;

        case 5:
            echo 'Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona comunicativa, dinámica, adaptable, magnética, interesante, vigorosa, versátil, rápida, audaz, aventurera, libre, despojada, seductora, jovial, inquieta. Atrayendo a los demás y alrededor tuyo no hay aburrimiento. Se puede mostrar también impulsiva, ansiosa, nerviosa, inestable e inconstante, no puede parar de hablar.';
            break;

        case 6:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona que se muestra maternal, protectora, responsable, consejera, armónica, amable, generosa, equilibrada, fiel, pulcra, compasiva, amorosa, hogareña, hospitalaria, cordial tanto con su familia como con sus amigos, alguien que se viste bien, elegante. Pero también se puede mostrar entrometida, queriendo imponer sus ideas a los demás.";
            break;

        case 7:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona analítica intelectual, estudiosa, reflexiva, introspectiva, espiritual, filosófica, mística, intuitiva, inspirada, selectiva, muy reservada, observadora. Notan también una elegancia autentica y natural. Una persona bohemia, poeta, fría, solitaria, tímida, de baja expresividad, aunque también desconfiada y prejuiciosa.";
            break;

        case 8:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona ejecutiva, alguien muy capaz de concretar grandes negocios, autoritaria, empresaria, prestigiosa, hábil, dominante, magnética, apasionada, ambiciosa, segura, amigable, valiente, resistente, líder natural y autentica, con grandes aptitudes para los negocios, comercio y finanzas. Pero también notan una persona explosiva, violenta, agresiva, déspota, o como alguien encerrada en sus ambiciones y objetivos personales";
            break;

        case 9:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona se muestra generosa, hermana de la humanidad, amorosa, de gran corazón, compasiva, cálida, amistosa, tolerante, apasionada , predispuesta, idealista, magnética, romántica, simpática, emotiva, sensible, afectuosa. Alguien que se ocupa y aflige por las necesidades del otro, desinteresada. Pero también se muestra ciclotímica, descuidada, muy frontal y fanática.";
            break;

        case 11:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona espiritual, inspirada, mística, intuitiva, soñadora, artística, humanitaria, prestigiosa, famosa. Pero también una persona que se puede mostrar nerviosa y muy egocéntrica.";
            break;

        case 22:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona constructiva, servicial, práctica, prestigiosa, con riqueza, con poder y de gran poder económico.";
            break;

        case 33:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona que se muestra modesta, humilde, caritativa, bondadosa, tierna, sacrificada, tolerante, espiritual, alguien siempre preocupada por los más necesitados.";
            break;

        case 44:
            echo "Se podría decir que, la primera impresión que das ante los ojos de quien te observa, es la de una persona que se muestra disciplinada. Alguien que muestra mucho poder en todo, alguien de prestigio, como un lider en negocios.";
            break;
    ...
    switch ($mide){
        ...
        case 1:    
            ...
            <br>
            Tu misión tiene que ver también con liberarse de todo vínculo familiar, proyectándote como pionera en un nuevo campo. Tenés valentía e inteligencia para explorar lo desconocido; a diferencia de la mayoría de los números, quien vibra con el número 1 aprende más por experiencia, pues le desagrada que le aconsejen. Sos orgullosa y casi siempre temperamental. En aspecto negativo, sos proclive a mandar a los demás y salirte con la suya; si ésta condición negativa se mantiene, deberás precaverte de la pereza, el cinismo, la inseguridad en lo que haces y en la preposición de mando hacia los demás. Por lo que tu misión tiene que ver con evitar ser obstinada, dominante y manipuladora.
            <br>';
            echo '<br>';
        ...
        case 2:
            ...
            <br>
            Debes aprender a ser receptiva, sensible, emotiva, cooperadora. No buscar el reconocimiento ni alabanza personal; sino que considerar como importante la bondad, la simpatía y los sentimientos ajenos; es importante, como parte de tu misión, cultivar la amistad y ser leal a ella. Debes ponerte bajo la Ley de Dar y Recibir. Como misión de tu alma, debes aprender a expresarte a través de la paciencia y la persistencia, nunca por el dominio. Encontrarás tu oportunidad en la diplomacia. La atracción del sendero Número 2 es sobre los grupos o comunidades.
            <br>
            Como número 2, la misión de tu alma será la de lidiar con la dualidad, siendo receptora de una emocionalidad muy fuerte, una gran sensibilidad, intuición y vulnerabilidad. Tu misión será la de avanzar y evolucionar en la colaboración, a desarrollar el control de las emociones y la capacidad de dar y recibir.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 3:
            ...
            <br>
            Hay tres tipos de tres: uno es la variedad estudiosa o mental; el otro la variedad social; y el tercero, la variedad emotiva y levemente inestables. Reconocer tu vibración en cada etapa de tu vida te ayudará a poder desplegar tus dones y cualidades.
            <br>
            Cuando no está equilibrado, puede generar actitudes de superficialidad, dispersión, inquietud, excesiva franqueza, falta de practicidad, celos e inmadurez. En el caso de percibirlo como carencia, nos muestra dificultades de expresión y comunicación, pesimismo y mal humor, rigidez mental, que impide el desarrollo de la imaginación, y dificultades para desarrollar también la creatividad.
            <br>
            Debés aprender a no dispersar tu talento en varias direcciones a la vez y centrar tu energía en tu autoexpresión. Ya que los números 3 disfrutan de la vida social, toman la vida como viene, aman el placer, con la expresión como nota clave, será de suma importancia para tu destino contemplar cómo es tu manera de expresarte hacia vos misma y cómo exteriorizas tu discurso; el peso que le pones a la mirada de tu entorno social. Este número en tu destino, te enseña a evolucionar en el optimismo, a desarrollar tus talentos creativos, y tu capacidad de expresividad. Por lo general escondes tus emociones, pensamientos y sentimientos, ya que eso te hace sentir expuesta y muy vulnerable; por lo que puede que no te muestres del todo como sos ante los demás; realizar una buena apertura al mundo será parte de tu destino.
            <br>
            Tu número de destino 3 tiene relación con el número del alma 9, la creatividad, la expresividad, la alegría, jovialidad y optimismo del número 3 va relacionarse con cómo contemplas al mundo y el modo de relacionarte con los demás, el 3 se manifiesta a través de tu expresión personal y lleva a interpretar la grandeza de la vida y proveer a tu entorno de balance y sabiduría. Tu destino al ser 3 va a tener que trabajar la expresividad, lo que llevará al despertar del espíritu y la imaginación para que los demás aprendan de tu sabiduría, alegría y creatividad. La relación de estos dos número, el de tu destino 3 y el la esencia de tu alma 9, te invita a ser creadora, inspiradora, artística, activa, optimista y amiga del mundo. Puesto que tenés el don de la palabra, muchas personas verán en vos una guía y una consejera.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 4:
            ...
            <br> 
            Tu misión tiene que ver también con ser constructora. Como número cuatro sos analítica, práctica, sistemática, decidida, sincera y ordenada; practicante de la disciplina, no temes al trabajo duro ni a la labor manual, causa que te hace merecedora de un puesto de mando, ya que como has aprendido a obedecer, sabes dirigir. A veces, si estás en desacuerdo con otros, podes ponerte inmovible debido a tu testarudez; por lo que será necesario que trabajes sobre tu amplitud de criterio y flexibilidad. Gracias a tu moderación e inclinación al ahorro podés llegar a adquirir un excelente ingreso y bienestar. Debes aprender a disfrutar de la vida, porque existe la tendencia a obsesionarte por las responsabilidades y la estabilidad.
            <br>
            Como misión tendrás la oportunidad de construir lo benéfico y duradero y a enseñar a otros menos evolucionados que vos.
            <br> 
            Tu misión está relacionada al público; podes asumir mucha responsabilidad y ayudar a proteger a los demás. Necesitas cultivar amplitud de criterio y el deshacerse de lo caduco, desarrollando una mente clara, objetiva, organizada, práctica, debe ser amorosamente servicial.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 5:
            ...
            <br>
            Generalmente tu alma es inquieta, impulsiva y rápida en su actuar, representa la energía intensa y movediza. Se puede decir que tenés una gran pasión por la aventura; a veces corres ciertos riesgos, si es necesario caminar en la cuerda floja lo harás; solo pensás en no desechar nada. Sabes cómo avivar una fiesta y entretener a las personas con una interesante conversación.
            <br>
            Los números cinco pueden ser súper-comerciantes. Se podría decir entonces, que hay un cierto gusto por la especulación y que tenés una gran visión financiera, ya que podrías utilizar hasta el último centavo de tu dinero en lo que crees que es conveniente. También puede que se dé una gran apertura al atletismo y las aventuras, podrías dirigir agencias de viaje o ser guía en una expedición alrededor del mundo. Pones tus energías en actividades sociales.
            <br>
            Tu misión tiene que ver también con evolucionar conectando el Cielo y la Tierra, desarrollando las cualidades de adaptación, y tu capacidad de libertad, movimiento y cambio. Tu misión se centra también en la búsqueda intelectual y en tu apertura; has aprendido la disciplina y el respeto a las normas, y ahora se expresa una necesidad de independencia, se despierta en tu Ser el deseo imperioso de libertad personal, de encontrar la verdadera identidad y fuerza interior; incluso a diferenciarte en tu modo de pensar y de vivir. Como ya se ha expresado, tu destino es la libertad y la independencia, la apertura mental, el cambio, la adaptación, el movimiento y la búsqueda de nuevas experiencias.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 6:
            ...
            <br> 
            Como destino sos una servidora de la humanidad, cualquier esfuerzo dirigido hacia la educación, el hogar o la familia son puntos claves para el éxito de un alma número seis. Tu misión tiene que ver con el ajuste y la armonía, aprendiendo a asumir responsabilidades, sirviendo amorosamente a los demás y dando libremente consejos. Debe poder ajustar situaciones y condiciones desarmonizadas en tu propia vida y en las vidas de aquellos con quienes entras en contacto. Tu destino es el de servir con alegría y contento, con eficacia, armoniosamente y aprendiendo a equilibrar los opuestos; enfrentándote a los problemas de la domesticidad y asumiendo muchas cargas que le pertenecen a aquellos más débiles por quienes sos responsable. Debes estar preparada a dar ayuda material o espiritual cuando te sea pedido.
            <br> 
            Tu misión tiene que ver también con la responsabilidad afectiva, el amor y el equilibrio armónico. Tu misión tiene que ver con evolucionar en armonía, ofrecer amor de manera desinteresada, apreciar la belleza y vivir en bienestar; comenzando a vivir el intercambio entre el dar y el recibir, de manera sensible. Tu misión tiene que ver con ser una madre/padre devoto, amando y brindando protección a tus hijos y los hijos del mundo. Será parte de su misión amar libremente, sin ver condicionada su vida y coartada su libertad por obligaciones familiares o autolimitaciones.
            <br>
            Tu misión tiene que ver con aprender a cuidar a los demás sin sobreprotegerlos o asfixiarlos. También de prevenir las discusiones, la testarudez o la intromisión respecto de los demás. Deberás aprender a considerar los puntos de vista de los demás y las críticas; mantener en todo momento tus propios ideales pero nunca buscar el ajuste obligando a otros a aceptar los tuyos. Será parte de tu destino aprender a vivir en un medio artístico, promoviendo la armonía en tu hogar. Ya que sos idealista de corazón, serás capaz de hacer mucho bien a la humanidad; encontrando tu oportunidad en el valioso servicio que rendirás a aquellos que necesitan ajuste espiritual o material.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 7:
            ...
            <br>
            Tu misión tiene que ver también con la reflexión, perfeccionismo y espiritualidad, pero no te solés destacar como práctica. Soñás grandes aventuras, ya que pensás en gran escala. La búsqueda del conocimiento está detrás de la adquisición de comprensión y sabiduría, tu nota clave es la perfección, no la popularidad. Debés aprender a confiar en tu intuición y aprender a oír la voz de tu alma. Podes captar fácilmente un engaño, o reconocer a un individuo superficial. Amas la naturaleza y sos afecta con los animales.
            <br>
            Tu número de destino y número de esencia trazan tu camino de crecimiento, el número 3 en tu esencia/deseo de tu alma, habla de la necesidad de dar alegría, dicha y felicidad, tu alma tiene un gran deseo de derramar su amor, energía y talentos; potenciar su capacidad de expresión y creatividad. Esto facilita tu misión, que al estar regida por un número 7, nos habla de un trabajo de elevarte a vos misma y a los demás, trabajar sobre la misericordia; con lo que también se necesitará una labor sobre tu Ego. Como destino, existe una necesidad de fortaleza, que te mantengas positiva de manera que siempre puedas influenciar a los demás en la elevación de su ánimo y espíritu. Tené en cuenta que el 7 puede tener: aura fuerte: el cual se impone por su presencia, puede llegar a ser manipulador, tirano, dictador. Si discutís con él, aunque sepas que está equivocado, terminas por aceptar su propuesta; o Aura débil: influenciable; sienten todo a flor de piel; se vuelven dependientes; no son líderes; dominados; a veces confunde la autoconfianza con egoísmo. Por ello tu aura debe estar en completo equilibrio y armonía.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 8:
            ...
            <br>
            Ya que los números 8 son mentales y bien equilibrados (es el número de libra, la balanza, significando equilibrio y organización), será de suma importancia para tu destino contemplar el justo balance. Si consideras estos puntos fundamentales tu misión será cumplida con muy poco esfuerzo de tu parte. La consigna deberá ser: “un pie por vez”, este principio, esta máxima, te conducirá hacia una mayor expansión de vos misma.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 9:
            ...
            <br>
            Como número nueve tu alma es una gran hermana de la humanidad. Por tu desinterés, darás incluso imprudentemente. Tu alma es compasiva, idealista y siente con facilidad las dificultades y necesidades ajenas, hasta el punto de sufrir personalmente por la desgracia de otros/as, o más bien, por la impotencia de no poder socorrerlos/as. El servicio es tu destino.
            <br>
            Tu misión tiene que ver también con la apertura de la mente y el espíritu, evidencia la Luz interior y la calidad de tu Ser. Te enseña a vivir con serenidad, aceptación, tolerancia y apertura espiritual. En el número 9 surge la capacidad de descubrir la calidad interior, de desarrollar la nobleza del alma. Es la vivencia de todas las energías anteriores integradas. Es parte del aprendizaje el dar y el recibir.
            <br>
            El destino de tu alma traza un camino, partiendo de la construcción a partir de la toma de consciencia; que se potencia con el número altruista 9, invitándote a abrir esta consciencia al servicio de los demás. Este dígito se relaciona con la ascensión a un grado superior de consciencia. De la capacidad de desplegar amor a los otros, de modo creativo, idealista, original y bondadoso.
            <br>
            Debes aprender a vivir con tolerancia, esperanza, libertad física y espiritual para abrirte a otros mundos y pensamientos. Podrías perder amigos, dinero y sufrir grandemente si no aprendes a vivir como un ser individual e impersonalmente. Tu misión está relacionada con desarrollar o equilibrar estos aspectos de sensibilidad, emotividad, intuición y servicio humanitario, ampliar los límites en pos de ideales y el sentido humanitario.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 11:
            ...
            <br>
            Tu destino está relacionado al misticismo, por lo que será necesario que amplies tu campo perceptivo, confíes en tu intuición, sigas tus corazonadas y tengas fe en tu guía superior. Para ello debe aprender a ser práctica y llevar a cabo tus planes en vez de dejarlos a medias, de lo contrario tenderás a vivir en las nubes sin realizar nada. Tenes que investigar el misticismo y aplicarlo al más alto de los usos. Debes estar siempre alerta para aprender o saber el tipo de iluminación y revelación que tienes que darle al mundo.
            <br>
            Es tu destino pensar primero en los demás, sirviendo en vez de realizar planes que sólo te benefician a vos misma. Por lo que no debes tratar jamás de acumular y obsesionarte por el dinero (sino caerás en la vibración del número 2).
            <br>
            Tu misión tiene que ver con ampliar tu camino de sabiduría y derramar tu propia luz; inspirando a los demás con tu propio ejemplo, viviendo la verdad que te es revelada. Tienes que vivir humildemente. Es posible que tu camino sea siempre abundante y logres gran fama si no lo buscas por motivos ulteriores.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
        ...
        case 22:
            ...
            <br>
            Se puede observar que, ante tu misión, tu consigna es “construir.” Tu destino está relacionado con realizar grandes obras que sirvan a la humanidad, proyectos ambiciosos y de gran amplitud, teniendo la posibilidad de trabajar a un nivel concreto, con estrategia y resistencia, para “construir” propósitos elevados.
            <br>
            Tu misión tiene que ver también con ser práctica e idealista; no solo teniendo visiones, sino que también viendo a gran escala y llevando a cabo tus planes para concretar tu meta. El 22 es una maestra constructora, da al mundo orden y sistema; el poder e influencia de los poseedores de este número pueden ser de gran alcance. Debería lanzar proyectos en beneficio de toda la humanidad, podés trabajar con grandes grupos ya que conseguís manejarlos perfectamente.
            <br>
            Este doble dígito 2 necesita equilibrar sus aspectos emocionales, para evitar vivir conflictos psicológicos que puedan llevarlos a problemas afectivos y vinculares. Hay también una gran necesidad de equilibrar tu energía física (4) que debe ser bien utilizada; si un veintidós no vive a pleno su vibración como número maestro o comodín benévolo, es posible que su esta descienda a un número cuatro. Este Número Maestro necesita canalizar sus potentes energías para no tensionarse o deprimirse, ya que su punto débil es lo emocional.
            <br>
            Como número 4 también tu misión se centra en ser constructora, siendo muy trabajadora y honesta; siendo consciente, digna de confianza, económica, excelente en pormenores y rutina. Analítica, práctica, sistemática, decidida, sincera y ordenada. Tu misión está relacionada a asumir mucha responsabilidad y ayudar a proteger a los demás. Lo que se debe tener en cuenta en su aspecto negativo o en desequilibrio, contemplar la rigidez, autolimitaciones, severidad, falta de expresividad, adicción al trabajo, falta de imaginación, comunicación y testarudez; también falta de sentido práctico, desorganización, irresponsabilidad, falta de disciplina y dispersión, imprudencia y poco humor.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
        ...
        case 44:
            ...
            <br>
            Es parte de tu destino mejorar el mundo, por lo que primero deberás purificar y construir tu mundo interno. Será necesario que alces tu templo personal, dando lugar a tu alma a sentir la armonía y la bendición que merece. Será necesario que despliegues tus dones y cualidades, para ello deberás deshacerte de todo lo que no te suma para evolucionar, limpiar tus memorias de sufrimiento y dolor, hacer un trabajo de perdón y aprender a amar desinteresadamente. Una vez que hayas realizado este camino se acercarán a vos las almas que debes acompañar, enseñándoles con el ejemplo. Será tu misión aceptar estas almas y aprender de ellas, en el camino que logren construir ambas evolucionarán.
            <br>  
            Como destino deberás ser consciente de que tenes una o varias misiones que cumplir, de manera que tendrás que realizar un trabajo interior para conectar con tu sabiduría, abrirte como canal y expandir tus dones. Será parte de tu misión solucionar los problemas materiales de tu comunidad, beneficiando a los más necesitados y desamparados.';
            echo '<br>';
            echo '"""""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""
            <br><br>
            """""""""""""""""""""LUGAR PARA EL ANALISIS"""""""""""""""""""""""""';
    ...
    echo '<br>';
                                            ...
                                            // SOBRE LA ENERGÍA QUE VIBRA EN TU NOMBRE
                                            // SOBRE LA ENERGÍA QUE VIBRA EN TU NOMBRE
                                            // SOBRE LA ENERGÍA QUE VIBRA EN TU NOMBRE
    ...
    switch ($sinoEvn){
        ...
        case 'si':
            echo 'Sobre la energía que vibra en tu nombre';
            echo '<br>';
            echo 'Voy a describir tus nombres para que sepas la energía en la que vibran, esto habla de tu comportamiento, conductas y talentos. Si utilizas tu primer nombre como nombre de pila, por el que todos te llaman, entonces vibrará esa energía en tu comportamiento, conducta y talentos, si en cambio utilizas tu segundo nombre, entonces será esta vibración la que motorizará lo dicho, entonces... ¿Qué dice tu nombre sobre vos misma?';
            echo '<br>';
    ...
    switch ($vono){
        ...
        case 'a':
            echo 'Tu nombre, al poseer como primer vocal la letra “A”, y al ser ésta una letra capital, implica acción, confiere espíritu de iniciativa, confianza propia, autoridad y fuerza de voluntad. Es una letra cerebral y creadora, posee actitud para dar impulso, adquirir y disponer. Como primera vocal del primer nombre, sos audaz, independiente, inquisitiva e interesada por la investigación. Sabes lo que querés y porqué lo querés.
            <br>
            //////////////////CONTROLAR//////////////////
            <br>
    ...
    switch ($voseno){
        ...
        case 'a':
            echo 'Tu segundo nombre, al poseer la letra “A” como vocal, y al ser ésta una letra capital, implica acción, confiere espíritu de iniciativa, confianza propia, autoridad y fuerza de voluntad. Es una letra cerebral y creadora, posee actitud para dar impulso, adquirir y disponer. Como primera vocal del primer nombre, sos audaz, independiente, inquisitiva e interesada por la investigación. Sabes lo que querés y porqué lo querés.
            <br>
            //////////////////CONTROLAR//////////////////
            <br>
            De poseer dos letras “A” en tu nombre completo, se puede decir que posees una mente muy despejada 
        ...
        case 'e':
            echo 'Tu segundo nombre al poseer la letra “E” como vocal, y al ser ésta una letra física indica actividad y movilidad, confiere la capacidad de relacionarse y comunicarse con absoluta libertad. Pasional, impulsiva, posees la capacidad de escuchar y escucharte a vos misma. Como primera vocal del primer nombre, se puede decir que llevas una vida excitante, plena de acontecimientos. Sos muy versátil, posees la capacidad de aprender fácilmente, aunque a veces te mostrás nerviosa y temperamental.
            <br>
            //////////////////CONTROLAR//////////////////
            <br>
            Si la E es la primera vocal de tu nombre y posees más de 3 en el nombre completo, tal vez tengas una naturaleza inconstante.';
    ...
    switch ($sinoLeka){
        ...
        case 'si':
            echo 'Lecciones Kármicas';
            echo '<br>';
            echo 'Las lecciones Kármicas no son un motivo para entrar en pánico o tomarlas como “el castigo del alma”, sino que son las lecciones para aprender, son las asignaturas pendientes, aquello que falta cumplir, las experiencias u obligaciones que evitamos o eludimos en vidas pasadas; y en el presente. Las lecciones Kármicas reflejan las cualidades y/o debilidades que posee el alma para esta vida. Es importante darles particular atención e intentar saldarlas, de otra manera, estas situaciones se pondrán frente a nuestro camino una y otra vez.';
            echo '<br>';
            echo 'Camino de Vida - Sendero Natal - Sendero de Vida - Vibración Kármica';
            echo '<br>';
            echo 'La pregunta es ¿Qué debo aprender? ¿A qué vinimos a esta vida?';
            echo '<br>';
    ...
    switch ($leka){
        ...
        case 1:
            echo 'Tu camino de vida posee la vibración del número 1, con ello podemos decir que viniste a esta vida a aprender a tener iniciativa, autoconfianza y decisión. 
            <br>
            Es importante que consideres esto como un punto fuerte para trabajarlo conscientemente. Lo que has venido a trabajar es la individualización; aprendiendo desde la independencia y adquiriendo la habilidad de manejarte sola; tenés que fortalecer tus propios poderes, hacer uso de tu astucia para inventar sistemas originales, nuevos, es decir, crear. Debes rechazar limitaciones, aprendiendo a colaborar o cooperar sin perder la individualidad, guiar, controlar y dirigir. Tenés que desarrollar tu cuerpo, mente y espíritu a su más alto punto de eficacia. Encontrarás tu oportunidad haciéndote valorable en cualquier situación en la que te encuentres y así tendrás un rápido avance, al punto de ser líder. La atracción en el Sendero Número 1 no es hacia las masas sino hacia las individualidades.
            <br>
            Podrás triunfar: como creadora, inventora, pionera, exploradora, creadora o engendradora, líder, directora, jefa, jefa ejecutiva, gobernadora, general o capitana, cabeza de institución. Dueña o editora de periódicos o revistas, dueña o cabeza de cualquier negocio. También en profesiones como arquitecta, ingeniera, maestra, comerciante, aviadora. Todo Número 1 tiene gran habilidad para comprar o vender. Entre otras vibraciones destacan tus cualidades mentales, las cuales te facilitan el camino para desarrollarte como escritora o abogada; existe una inclinación hacia el lado creador, por lo que estas cualidades, te permiten ejercer como modista y diseñadora.
            <br>
        ...
        case 2:
            ...
            <br>
            La gran lección que viniste a aprender tiene que ver con lograr sumergirte y seguir las indicaciones de otros. Es un llamamiento a ser la pacificadora, diplomática, y mediadora. Tenés que trabajar cuidadosa y pacientemente en los mínimos detalles, impulsada por la idea del servicio y la cooperación. Tenés que aprender el poder del silencio, a mezclarte con todo el mundo, sin buscar reconocimiento o alabanza personal. Debés considerar como importante la bondad, la simpatía y los sentimientos ajenos, cultivando la amistad y ser leal a ella, comprendiendo la Ley de Dar y Recibir. Es necesario que aprendas a expresarte a través de la paciencia y la persistencia, nunca por el dominio; cultivándote en la escucha y absorbiendo lo que te permita crecer. Encontrarás tu oportunidad en la diplomacia y entre los muchos amigos/as quienes te acompañarán en tu camino evolutivo. La atracción del sendero Número 2 es sobre los grupos o comunidades.
            <br>
            Profesiones y oficios que vibrarían con vos: estadista, contadora, empleada pública, diplomática, política, bibliotecaria, artista musical, pintora, pacificadora, psicóloga, estudiante, maestra, secretaria u oficios de oficina, compiladora, obrera especializada, doméstica, artista, cantante de coro, bailarina de grupo, psíquica o médium; los número 2 se adaptan a ocupaciones en las cuales trabajan asociados con otros, ellos no guían, son seguidores, son voceros de otros y pacificadores de todos por su tacto innato y deseo de armonía. Encontramos entre ellos nuestros más grandes diplomáticos, por su reacción instintiva al ritmo en todas las cosas; destacan también entre ellos músicos y bailarines. Se encuentran más cómodos en ocupaciones donde el detalle y la minuciosidad son importantes.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
            break;
        ...
        case 3:
            ...
            <br>
            La gran lección que viniste a prender es sobre la expresión personal, tiene que ver con la manifestación de tus talentos para expresarte cuando hablas, escribís o actúas. La auto-expresión es sin duda la tarea incesante de un número tres. Debe aprender a expresarte bien, pues tenes el don de la palabra. Debe ser creadora y utilizar tus cualidades intuitivas e imaginativas.
            <br> 
            Debes evitar ser crítica de los demás, impaciente, intolerante y excesivamente optimista. Un buen tanto por ciento de números tres, nacieron en una familia donde se lo reprimió o fue obligado a realizar tareas minuciosas, manuales y rutinarias, que le impidieron utilizar su iniciativa y talento creador. Tenes que aprender a dar de vos misma, libre y gozosamente. Tenes que cultivar contactos sociales y ser una participante bienvenida en todas las reuniones; haciéndote muy valiosa por tu habilidad de iluminar la oscuridad. Debes aprender a expresarte a través del arte, la belleza, los amigos y la felicidad. Encontrarás tu oportunidad en el lado ligero de la vida mezclándote en sociedad y ocupándote de cosas agradables. Debes buscar la ocupación que te da la oportunidad de expresarte artísticamente, aprovechando toda ocasión para usar palabras, sea hablando, actuando, cantando o escribiendo. La atracción en el sendero Número 3 es sobre individuos y masas.
            <br>
            Profesiones y oficios que vibrarían con vos: Artista en palabras, poetiza, dramaturga, humorista, oradora, escritora, actriz, comediante, directora. Artista en música, ejecutante en cualquier instrumento, cantautora. Artista en tela, diseño, pintura y dibujo. Crítica de conferencia o escritura. Animadora en escena, club o sociedad, organizadora o líder social. Trabajadora social, sacerdotisa, misionera, o cualquier rama espiritual que brinde ayuda y guía. Comerciante, joyera sombrerera, decoradora o modista, especialmente de productos de belleza. Todos los 3 pueden vender por sus métodos de presentación efectivos e imaginativos. Están más cómodos en las alegres decoraciones. El 3 mental se inclina naturalmente a la escritura, el emocional a la actuación y el canto. Los más frívolos, a la sociedad y el adorno o decorado de la misma.
            <br>
        ...
        case 4:
            ...
            <br>
            Es importante que consideres esto como un punto fuerte a trabajar conscientemente, ya que las bases numerológicas te aportarán la clave del aprendizaje. Lo que has venido a trabajar es la estabilidad. Tenés que aprender la atención estricta para con el deber; a su vez es importante aprender a servir y a producir. Has venido a aprender a superar la aparente limitación y hacer sustancial y perfecta la forma en que estás trabajando. Encontrarás tu oportunidad profunda y variada; tendrás la oportunidad de construir lo benéfico y duradero y a enseñar a otros menos evolucionados que vos. Este sendero tiene posibilidades de grandes logros; la paciencia, servicio y dependencia tendrán los premios y la confianza que inspira a otros. La atracción del sendero número 4 es sobre las comunidades.
            <br>
            Tendrás que aprender sobre la evolución; emprender el camino de cumplir tu misión porque éste es el final de una serie de iniciaciones. El ser una pensadora profunda facilitará el camino de tu alma y ayudará en el aprendizaje.
            <br>
            En la vibración de este número podrás triunfar como: contratista, granjera, mecánica, dibujante, obrera, capataz, contadora, política y todas aquellas actividades rutinarias. Autora de obras técnicas, economista, técnica y estadista, profesora o instructora, organizadora, ejecutiva y compradora. Científica, operaria técnica. Médica o cirujana, química en la manufactura, electricista, constructora, maestra de obra, horticultora, músico de orquesta. Todo Número 4 se expresa mejor en los medios materiales. Es altamente mental; elige escribir o enseñar. Se empeña en la organización, sistema o la precisión. Entre las mujeres encontramos numerosas costureras, muchas de las cuales son domésticas rutinarias.
            <br>
            Para hacer elecciones que te hagan crecer tené en cuenta los deseos de tu alma, ya descriptos al principio del informe.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
         break;
        ...
        case 5:
            ...
            <br>
            La gran lección que viniste a aprender tiene que ver con la libertad, debés esperar cambios frecuentes, variedad, viajes y lo inesperado. Tenés que aprender el uso correcto de la libertad, permaneciendo alerta a todo lo nuevo y progresivo, adaptándote a circunstancias y condiciones poco comunes. Es importante aprender idiomas y comprender las distintas clases de personas, culturas e ideas buscando constantemente lo nuevo, lo desconocido y beneficiándote en cada experiencia. Debés aplicar tu ingenio y seguir varios ángulos de desarrollo.
            <br>
            Encontrarás tu oportunidad lejos del camino trillado si aprendés a descartar lo que no te es útil y no te quedás en la rutina. Encontrarás a personas con gran inventiva, de numerosos recursos, que te beneficiarán si haces el esfuerzo de encontrarlas. Crecerás por medio de la adaptación al cambio y la inseguridad. La atracción en el sendero Número 5 es sobre las multitudes, el conjunto de totalidades. 
            <br>
            Profesiones y oficios que vibran con vos: vendedora, psicóloga, investigadora, viajante, corredora de seguros o bolsa. Senadora, oficial del servicio civil, líder cívica, abogada, detective, escritora y/o editora, actriz, animadora, oradora, promotora, crítica dramática, jefa de dirección en teatro, especialista electricista, inventora, científica. Los 5 saben hacer de todo, son hábiles en todo, son los mejores vendedores porque comprenden todos los ángulos de aproximación, son simpáticos, amables y caen bien en todos los grupos. Su mayor éxito se da en las ocupaciones en las cuales se encuentran en contacto con la gente. Se sienten infelices en una oficina y tienen que tener perfecta libertad de palabra y acción; son viajeros natos.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
            break;
        ...
        case 6:
            ...
            <br>
            La gran lección que viniste a prender, tiene que ver con el ajuste y la armonía; debiendo cultivar el significado de la responsabilidad. Debes poder ajustar situaciones y condiciones desarmonizantes en tu propia vida y en la vida de aquellos con quienes entras en contacto. Debes servir con alegría, contento, eficacia, reposadamente y aprendiendo a equilibrar los opuestos. Debes enfrentarte a los problemas de la domesticidad y a asumir muchas cargas que les pertenecen a aquellos más débiles por quienes sos responsable. Debes estar preparada a dar ayuda material o espiritual cuando te sea requerido.
            <br>
            Es favorable mantener en todo momento tus propios ideales, nunca buscar el ajuste obligando a otros a aceptar los tuyos. Te será necesario estar preparada para servir a la familia, la comunidad o el universo si fuera necesario. Encontrarás tu oportunidad en el valioso servicio que rendirás a aquellos que necesitan ajuste espiritual o material. La atracción del sendero Número 6 es sobre la familia, comunidad, el estado o el mundo.
            <br>
            Profesiones y oficios que vibrarían con vos: cantante, decoradora, asistente social, arquitecta, cocinera, artista, actriz dramática, artista musical, médica o enfermera, jefa de hospital, obrera social, jefa de una institución de personal, maestra, escritora, ejecutiva de hotel, restaurante o salón de té; ocupada en alimentos y bebidas. Los 6 necesitan una situación de responsabilidad y confianza; ya que regulan, armonizan y ajustan, tienen éxito en todas las ocupaciones conectadas con el hogar, instituciones o proyectos que tiendan a mejorar las condiciones materiales, civiles, educacionales. Se interesan en el cuidado de los ancianos, en el entrenamiento de la juventud y el mejoramiento de toda la comunidad.
            <br>
            Para hacer elecciones que te hagan crecer tené en cuenta los deseos de tu alma, ya descriptos al principio del informe.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
        ...
        case 7:
            ...
            <br>
            Es importante que consideres esto como un punto fuerte a trabajar conscientemente, ya que las bases numerológicas te aportarán la clave del aprendizaje. Lo que has venido a trabajar es la sabiduría y la soledad: debes aprender del análisis mental. Debes buscar la sabiduría y las verdades ocultas, desarrollarte subjetivamente para evolucionar como una alta sacerdotisa o buena consejera. Debes aprender a estar sola, pero no sentirte solitaria. Trabajar en teorías y fundamentos, aumentar constantemente tu provisión de conocimientos útiles. No debes ocuparte de acumular posesiones materiales y aprender a encontrar en el espíritu la verdadera riqueza aplicando leyes espirituales a asuntos materiales. Debes reposar, estudiar, meditar, adorar, estar en silencio y conocerte a vos misma. No debes insistir en asociarte a otros o ser líder de algo. Debes aprender a conocer el mundo invisible. Encontrarás tu oportunidad en aquello que llega en forma natural y espontánea sin forzar las situaciones por vos misma; esto implica buscar en lugares callados, lejos del ruido, la confusión y el bullicio. La atracción del sendero número 7 es sobre quienes necesitan teorías o verdades sobre la vida.
            <br>
            Podrás triunfar como: legalista, jueza, abogada, experta en electricidad o minas, banquera, contadora, experta corredora de bolsa, relojera, tejedora, experta en alfombras, inventora, escritora, escritora técnica, científica o filosófica, editora, maestra, inventora, actriz, analista. Decana de universidad o administradora, clériga, naturalista, horticultora, astrónoma, ocultista, autoridad en religiones, ceremonial y música sacra. Los 7 dan la palabra final en cualquier forma de expresión en que actúen. Son perfeccionistas y no hablan hasta que no están seguros. Se sienten cómodos en cualquier línea de trabajo ejecutivo que no lo lleven al campo mecánico de un negocio. Ellos son los pensadores y los sapientes.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
            break;
        ...
        case 8:
            ...
            <br>
            Lo que has venido a trabajar es el poder, la libertad material, debiendo estar en un mundo de actividades comerciales, asuntos de negocios y logros, de forma equilibrada. Debes cultivar un horizonte amplio y rehusar toda limitación, desarrollando la eficacia y el saber dirigir. Aprendiendo tanto a aceitar como a manejar la maquinaria, tratando con las cosas materiales de la vida, evitando sueños, visiones y cosas imprácticas. Debes aprender las leyes que rigen el dinero, su acumulación, su poder y su uso. Encontrarás tu oportunidad entre personas y condiciones de riquezas y aquellos que necesitan de eficacia y habilidad ejecutiva. La atracción del sendero número 8 es sobre las grandes corporaciones y organizaciones. Recordá que todo esto se debe manejar desde el punto de la justicia y el equilibrio, aprendiendo a reconocer el equilibrio entre las fuerzas materiales y espirituales.
            <br>
            Podrás triunfar: En el comercio sos apta para triunfar en casi todos los campos, incluso como presidenta o gerente de una compañía. Otras perspectivas abiertas son como industrial o ejecutiva. También podes ser atraída hacia el código de comercio, actividades bancarias, asuntos cívicos y política. Si un número 8 escoge una carrera literaria, por lo común es de editora o crítica, nunca autora, aunque podría escribir un libro sobre cómo actuar, relativo a alguna fase comercial. Financiera, corredora de bolsa, banquera, directora ejecutiva, magnate comercial, constructora o dueña de valores y ferrocarriles; manufacturera, fabricante, compradora y vendedora en gran escala, jefa de corporación, consultora, promotora ejecutiva, periodista, experta en comercio, navegación, transporte, patrona de arte en lo comercial, organizadora de caridades. "Negocios grandes" es el slogan dell número 8. Obtenés tu mayor éxito cuando te ocupas de las cosas grandes y materiales de la vida. Siempre ganarás si te mantenés positiva y no admitís limitaciones.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
            break;
        ...
        case 9:
            ...
            <br>
            Es importante que consideres esto como un punto fuerte a trabajar conscientemente, ya que las bases numerológicas te aportarán la clave del aprendizaje. Lo que has venido a trabajar es la universalidad y la fraternidad. Tenés que aprender a ser humanitaria, trabajadora social; aprendiendo a amar y a servir a tu prójimo; abandonando todo prejuicio y aceptando a las personas como son, con sus errores y aciertos. Es importante estar al servicio y renunciar a la ambición personal, la codicia y el egoísmo. Debes atraer todas las cosas pero no atarte a ninguna. Es importante que veas al mundo como parte de tu esencia, tu hogar.
            <br>
            Tendrás que aprender la Ley del cumplimiento o realización o estar colmado, de cumplir tu misión porque éste es el final de una serie de iniciaciones. Ser expresiva y creativa, facilitará el camino de tu destino y ayudará en el aprendizaje al que vino tu alma en este plano. Esto se trata de dar amor, ser compasiva, ayudar y comprender sin límites. Encontrarás tu oportunidad entre la gente emotiva, artística e inspirada, tenés que aprender de la más alta vibración del artista, es importante que reconectes con esta parte y la potencies para tu evolución. La atracción del sendero número 9 es hacia los muchos o hacia todos, es decir que no hay tintes de individualismo, sino que hay una apertura a la Universalidad.
            <br>
            Podrás triunfar como: médica, enfermera, filántropa, abogada, escritora, actriz, pintora, bailarina o en labor comunitaria, sirviendo al público. Una número nueve se siente cómoda ayudando a los demás. Artista en cualquier línea. Si es actriz se inclina hacia la tragedia. Maestra, sanadora, predicadora, reformadora, escritora, compositora. Jueza, abogada criminal o penal, consejera, médica cirujana y todas las artes y medicinas relacionadas a lo humanitario. El 9 da libremente de sus emociones en todas las formas de expresión, trabaja mejor en aquellos aspectos de la vida donde la inspiración, la bondad y la comprensión humana son esenciales.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
            break;
        ...
        case 11:
            ...
            <br>
            Dada la vibración del número 11, podemos decir que viniste a esta vida a aprender a ejercer un determinado tipo de liderazgo, mediante la sensibilidad y emotividad (por la vibración del número 2), con ideas transformadoras, capaces de cambiar la sociedad.
            <br>
            Lo que has venido a trabajar es tu propia maestría; aprendiendo desde la Revelación, tendrás que especializarte en la subjetividad, llevando todo al plano de la inspiración, siendo la ultra-especialista, desarrollando talentos de invención o buscando descubrir nuevos principios. Tenés que investigar el misticismo y aplicarlo al más alto de los usos; confiando en tus intuiciones y teniendo fe en una guía superior. Debes estar siempre alerta para aprender o saber el tipo de iluminación y revelación que tenes que darle al mundo. No debes tratar jamás de acumular (el Número 2) y debes evitar toda tendencia excesiva a la acumulación de dinero sin sentido.
            <br>
            Realizando que el Número 11 tiene que derramar su propia luz. Tenes que inspirar a los demás con tu propio ejemplo, viviendo humildemente la verdad que te es revelada. Encontrarás tu oportunidad en las líneas espirituales, en el camino que elijas transitar. Es posible que logres gran fama si no la buscas por motivos ulteriores. La atracción del sendero Número 11 es hacia lo inspirado, los idealistas artísticos hacia aquellos que necesitan elevación espiritual.
            <br>
            La gran lección que viniste a recorrer y a aprender, es lograr transmitir la riqueza interior y la apertura espiritual, manifestándote como un canal conector de las energías cósmicas y universales, para estimular y orientar a los demás. Hay una naturaleza fuerte y exigente en esta vibración que puede llegar a aislarte y traer problemas personales (más aún si vibra en negativo).
            <br>
            Con la vibración 11 estas dotada de una gran energía creativa y espiritual, que muchas veces si no se vive de un modo equilibrado y consciente puede llevar a la vulnerabilidad emocional, excesos de impaciencia y complejos de “superioridad”. Este número Maestro te llama a desarrollarte y para ello debe existir un gran trabajo sobre tu ego.
            <br>
            Podrás triunfar como: psicóloga, maestra, oradora, escritora, filósofa, misionera, trabajadora social, trabajadora de caridad, líder de movimientos sociales, actriz, exploradora, inventora, en radio, televisión, astróloga o comunicadora social. Todos los 11 buscan expresar sus ideales, son más felices cuando logran encender la luz de su propia visión e inspiración, ellos no están adaptados al mundo de los negocios; por lo que este mundo puede hacerlos sentir oprimidos o bloqueados.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
            <br>';
            break;
        ...
        case 22:
            ...
            Estás llamada a realizar grandes obras que sirvan a la humanidad, viniste a esta vida a realizar proyectos ambiciosos y de gran amplitud, tenés la posibilidad de trabajar a un nivel concreto, con estrategia y resistencia, para “construir” propósitos elevados. Este doble dígito 2 necesita equilibrar sus aspectos emocionales, para evitar vivir conflictos psicológicos que puedan llevarte a conflictos afectivos y vinculares. Este Número Maestro necesita canalizar sus potentes energías para no tensionarse o deprimirse, ya que su punto débil es lo emocional.
            <br>
            En esta vida debes aprender a servir en una escala amplia y constructiva. Tenes que hacer usar tu poder desde un ángulo espiritual e idealista; hacer de lo inservible algo útil y práctico, de lo pequeño algo enorme. Encontrarás tu oportunidad en grandes movimientos internacionales, comerciales o instituciones filantrópicas o políticas, en asuntos de gobierno, etc. Tendrás la oportunidad de hacer real el sueño de paz, amor, felicidad, trabajo y prosperidad. La atracción del sendero No. 22 es sobre las masas, gobiernos, países, y razas que necesitan desarrollo y expresión.
            <br>
            En la vibración de éste número podrá triunfar como: embajadora, escritora, presidenta, maestra, diplomática, directora de asuntos mundiales u organizadora de obras públicas. Constructora, compradora en grandes empresas, reformadora práctica, líder, gobernadora, estadista, mandataria, experta en eficiencia, coaching. Los 22 abren nuevos campos y construyen los caminos que hacen fácil el acceso a ellos. Establecen comunicaciones internacionales y controlan eficazmente el todo y las partes. Embellecen mientras construyen.
            <br>
            A su vez el 22 y se reduce a 4, es decir que hay también una gran necesidad de aprender, en esta vida, a ser práctica, objetiva, responsable y disciplinada. Tu Sendero Natal coincide con tu número de identidad, por lo que no es solo aquello que venís a aprender en esta vida, sino que además es aquello que los demás pueden ver en vos a simple vista, es decir que es posible que las personas lleguen a mostrarte en lo que debes evolucionar.
            <br>
            Es importante que consideres esto como un punto fuerte a trabajar conscientemente, ya que las bases numerológicas te aportarán la clave del aprendizaje. Lo que has venido a trabajar es la estabilidad. Tenés que aprender la atención estricta en o al deber; a su vez es importante aprender a servir y a producir. Has venido a aprender a superar la aparente limitación y hacer sustancial y perfecta la forma que estás trabajando. Encontrarás tu oportunidad profunda y variada; tendrás la oportunidad de construir lo benéfico y duradero y a enseñar a otros menos evolucionados que vos. Este sendero tiene posibilidades de grandes logros; la paciencia, servicio y dependencia tendrán los premios y la confianza que inspira a otros. La atracción del sendero número 4 es sobre las comunidades.
            <br>
            Tendrás que aprender sobre la evolución; emprender el camino de cumplir tu misión porque éste es el final de una serie de iniciaciones. Como se ha mencionado la misión de tu alma/destino, de ser una pensadora profunda, facilitará el camino de tu destino y ayudará en el aprendizaje a la que vino tu alma en este plano. 
            En ésta vida viniste a aprender a trascender fronteras personales (22), a través de la objetividad, la responsabilidad y práctica (4), para la construcción de grandes ideales espirituales.
            <br>
            En la vibración de éste número podrá triunfar como: contratista, granjera, mecánica, dibujante, obrera, capataz, contadora, política y todas aquellas actividades rutinarias. Autora de obras técnicas, economista, técnica y estadista, profesora o instructora, organizadora, ejecutiva y compradora. Científica, operaria técnica. Médica o cirujana, química en la manufactura, electricista, constructora, maestra de obra, horticultora, músico de orquesta. Todo Número 4 se expresa mejor en los medios materiales. Es altamente mental; elige escribir o enseñar. Se empeña en la organización, sistema o a la precisión. Entre las mujeres encontramos muchas costureras y muchas son domésticas rutinarias.
            <br>
            Para hacer elecciones que te hagan crecer tené en cuenta los deseos de tu alma, ya descriptos al principio del informe.
            <br>
            //////////////////ACÁ VA LA CONCLUSIÓN//////////////////
    ...
    switch ($sinoPla){
        ...
        case 'si':
            echo "Planos de existencia";
            echo '<br>';
            echo 'De las Lecciones Kármicas se desprenden los Planos de Existencia, conociendo de qué modo influyen los números en los diferentes planos de la vida nos permiten entender el porqué de determinadas actitudes, y en qué plano nos desenvolvemos mejor. También nos indicarán los aspectos en los cuales debemos trabajar, ya sea para equilibrar, desarrollar o potenciarlos. Los planos en los que nos dividimos son cuatro:';
            echo '<br>';
    ...
    switch ($clavePer) {
        ...
        case '6':
            ...
            <br>
            Tu clave personal 6 pide que potencies lo positivo, esto sería tu parte amorosa, afectiva, tu equilibrio emocional, tu parte maternal, aquella belleza armónica que permite vincularte con vos misma y con el entorno de manera saludable y constructiva. Ante los conflictos posees gran fuerza interior, generando seguridad y protección al entorno, mediante la dulzura, el amor y la ternura.
            <br>
    ...
    if(isset($_POST["calcular"]))
    {
        if(isset($_POST["siEqui"]))
            echo 'Equilibrios, excesos y carencias
            <br>
            Tener en cuenta las carencias, equilibrios o excesos de los dígitos que se encuentran en tu nombre, te dará más conocimientos sobre vos misma.
            <br>
            Los números en equilibrio son los números que están en sintonía con tu vibración.
            <br>';

        if(isset($_POST["1Equi"]))
            echo 'En este caso, se puede mencionar que has hecho un buen uso del mando y la autoridad en otra vida y hoy podés mostrarte segura de tus capacidades sin necesidad de imponer tu voluntad.
            <br>';
            
        if(isset($_POST["2Equi"]))
            echo 'En tu caso, pude observar que en otra vida llevaste una convivencia en pareja confortable y trabajaste en equipo cómodamente, por lo cual en esta vida poseés gran sensibilidad, facilidad para la convivencia y colaboración con el otro.
            <br>';
                
        if(isset($_POST["3Equi"]))
            echo 'Puedo observar que en otra vida trabajaste en el mundo de las artes, lo cual significa que en esta vida tenés acceso y facilidad para practicarla en cualquiera de sus formas.
            <br>';
            
        if(isset($_POST["4Equi"]))
            echo 'Puedo observar que en una vida anterior estuviste en contacto con la tierra y el trabajo rutinario; por ello posees hoy conocimientos de las necesidades primarias.
            <br>';

        if(isset($_POST["5Equi"]))
            echo 'En otra vida has trabajado el desarraigo, lo que hoy te lleva a adaptarte a las diferentes personalidades, situaciones y lugares.
            <br>';

        if(isset($_POST["6Equi"]))
            echo 'En tu caso, muestran que en otra vida has trabajado el amor a la familia o comunidad en la que vivías, por eso en esta vida, serás solidaria, comprensiva, y fraterna con tu entorno.
            <br>';

        if(isset($_POST["7Equi"]))
            echo 'En una vida anterior trabajaste en el recogimiento, la investigación y el intelecto, lo que hace de vos en esta vida una persona introspectiva que emplea con acierto su mente.
            <br>';

        if(isset($_POST["8Equi"]))
            echo 'En otra vida trabajaste muy bien en el sector del comercio y la justicia, eso significa que en esta vida, sabrás aplicar dichas cualidades en el campo que elija.
            <br>';

        if(isset($_POST["9Equi"]))
            echo 'En tu caso podemos decir que en una vida anterior trabajaste en obras que beneficiaron a la humanidad, y ello hace que en el presente seas una persona de elevados ideales y poseas una naturaleza de ayuda hacia los demás.
            <br>';

        if(isset($_POST["noEqui"]))
            echo 'En tu caso pude observar que no posees números en equilibrio para trabajar.
            <br>';
    ...
    if(isset($_POST["calcular"]))
    {
        if(isset($_POST["siExce"]))
            echo 'Los dígitos de exceso, representan aquello que se recomienda equilibrar o cuidar de no llevar a los extremos.
            <br>';

        if(isset($_POST["1Exce"]))
            echo 'Puedo observar que en otra vida has abusado de la autoridad, pudiendo haber sido una déspota o muy egoísta, por lo cual ahora mostrarás una tendencia al mando y el egoísmo.
            <br>';
            
        if(isset($_POST["2Exce"]))
            echo 'Puedo observar que en otra vida trabajate o has sido amante de las artes y tambien existió una dependicia de la pareja o los equipos, lo cual hará que en esta vida te vincules con las artes y sepas trabajar en equipo; podrías tener incluso una tendencia a la dependencia afectiva.
            <br>';
                
        if(isset($_POST["3Exce"]))
            echo 'Puedo observar que en otra vida has estado muy conectada con la creatividad, las letras y la expresión artística , lo cual en esta vida te llevará a tener gran imaginación y facilidad para el uso del lenguaje, sea este escrito u oral.
            <br>';
            
        if(isset($_POST["4Exce"]))
            echo 'Puedo observar que en otra vida has trabajado mucho con tus manos en tareas de precisión, minuciosas, abnegadas o rutinarias, cualidades que podrán verse ahora a través de la economía, el trabajo, la sistematización y el orden.
            <br>';

        if(isset($_POST["5Exce"]))
            echo 'Puedo observar que en otra vida has abusado de tu libertad y sido inconstante en alguno o todos los aspectos incluido el sexo, eso puede marcar en la actualidad una tendencia al libertinaje y el cambio continuo en cualquier área.
            <br>';

        if(isset($_POST["6Exce"]))
            echo 'Puedo observar que en otra vida estuviste a cargo o has sido consejera de una comunidad o gran familia, eso te hará sumamente maternal/paternal, pero con una tendencia a aconsejar a dichos miembros según tu forma de pensar.
            <br>';

        if(isset($_POST["7Exce"]))
            echo 'Puedo observar que en otra vida has sido una ermitaña o te dedicaste a la investigación y búsqueda espiritual, lo cual mostrará en esta vida una tendencia al retraimiento y búsqueda de momentos de soledad o interés por cuestiones metafísicas, esotéricas y/o religiosas.
            <br>';

        if(isset($_POST["8Exce"]))
            echo 'Puedo observar que en otra vida manejaste mucho poder, has administrado o poseído muchos bienes, lo que puede llevarte hoy a desarrollar una gran capacidad comercial o administrativa que te haga triunfar en empresas financieras o administrarte muy bien; pero con una tendencia excesiva por el dinero o el poder. También pudiste estar ligada a la justicia.
            <br>';

        if(isset($_POST["9Exce"]))
            echo 'Puedo observar que en otra vida has hecho una entrega enorme por los demás, eso hace que ahora estés preparada para afrontar todas las vicisitudes de la tierra, con altruismo, inclusive en detrimento de tu propia persona. También podés mostrar actitudes artísticas y creativas, ya que la tarea puede haberse dado en ese campo.
            <br>';

        if(isset($_POST["noExce"]))
            echo 'En tu caso pude observar que no posees números en exceso para trabajar.
            <br>';
    ...
    if(isset($_POST["calcular"]))
    {
        if(isset($_POST["siCare"]))
            echo 'Los números en carencia marcan aquello que tenés que trabajar un poco más, es importante meditar sobre ello, reverlo, hay una asignatura pendiente que puede estar molestando un poco y en la cual debes trabajar.
            <br>';

        if(isset($_POST["1Care"]))
            echo 'Pude observar que en otra vida careciste de iniciativa e independencia, por lo cual en esta vida podés mostrarte insegura o puede costarte tomar decisiones.
            <br>';
            
        if(isset($_POST["2Care"]))
            echo 'Pude observar que en otra vida has sido muy individualista, eludiendo el compromiso de la pareja, por eso ahora, puede faltarte sentido de cooperación y sensibilidad para con los otros.
            <br>';
                
        if(isset($_POST["3Care"]))
            echo 'Pude observar que en otra vida has sido muy insegura y te costó crear y expresarse, por eso ahora podés tener tendencia a pasar inadvertida y tener difícultad para expresarte.
            <br>';
            
        if(isset($_POST["4Care"]))
            echo 'Pude observar que en otra vida te desagradó él trabajo rutinario y la economía por lo cual hoy podrías mostrar poca predisposición para hacer actividades que requieren de un esfuerzo repetitivo, prestar atención a los pormenores y aquello que constituye una obligación.
            <br>';

        if(isset($_POST["5Care"]))
            echo 'Pude observar que en otra vida has sido una persona de grandes arraigos, que ha sufrido gran temor a enfrentar el cambio o algo nuevo, lo cual puede significar que ahora no te adaptes fácilmente a las distintas situaciones o personas y te falte curiosidad e interés por tus semejantes.
            <br>';

        if(isset($_POST["6Care"]))
            echo 'Pude observar que en otra vida no quisiste atarte a ningún vínculo que te limitara ni asumir compromiso de familia, por lo cual puede haber ahora una tendencia a no hacerte cargo de las obligaciones hogareñas y actuar con irresponsabilidad.
            <br>';

        if(isset($_POST["7Care"]))
            echo 'Pude observar que en otra vida careciste de fe y de capacidad para conectarte con tu interior, lo que significa que en esta vida podrías mostrar una tendencia a la falta de análisis y concentración.
            <br>';

        if(isset($_POST["8Care"]))
            echo 'Pude observar que en otra vida predominó el despilfarro o careciste de eficiencia e interés por el dinero o bienes que te fueron concedidos, por lo cual en esta vida, encontrarías dificultad en obtener o mantener dichos bienes o recursos.
            <br>';

        if(isset($_POST["9Care"]))
            echo 'Pude observar que en otra vida existió la falta interés y comprensión por los demás, hechos que ahora pueden llevarte a vivir experiencias emotivas y altibajos.
            <br>';

        if(isset($_POST["noCare"]))
            echo 'En tu caso pude observar que no posees números en carencia para trabajar.
            <br>';
    ...
    function a($dia) {
        $resultadoDia = 0;
    if(strlen($dia) > 1) {
        $resultadoDia += a(array_sum(str_split($dia)));    
    } else {
        return $dia;
    }
    return $resultadoDia;
    ...
    function b($mes) {
        $resultadoMes = 0;
    if(strlen($mes) > 1) {
        $resultadoMes += b(array_sum(str_split($mes)));    
    } else {
        return $mes;
    }
    return $resultadoMes;
    ...
    function c($año) {
        $resultadoAño = 0;
    if(strlen($año) > 1) {
        $resultadoAño += c(array_sum(str_split($año)));    
    } else {
        return $año;
    }
    return $resultadoAño;
    ...
    function d($sendero) {
        $resultado = 0;
        if(strlen($sendero) > 1) {
        $resultado += d(array_sum(str_split($sendero)));    
        } else {
        return $sendero;
        }
        return $resultado;
    ...
    $etapa1 = 36 - d($sendero);
    $etapa2 = $etapa1 + 9;
    echo  "1) Primera Etapa: desde el nacimiento hasta los $etapa1 años.";
    echo '<br>';
    
    $etapa2 = $etapa1 + 1;
    $finEtapa2 = $etapa2 + 9;
    echo "2) Segunda Etapa desde los $etapa2 años hasta los $finEtapa2 años.";
    echo'<br>';
    
    $inicioEtapa3 = $finEtapa2 + 1;
    $finEtapa3 = $inicioEtapa3 +9;
    echo "3) Tercera Etapa desde los $inicioEtapa3 años hasta los $finEtapa3 años.";
    echo '<br>';

    $inicioEtapa4 = $finEtapa3 + 1;
    echo "4) Cuarta etapa desde los $inicioEtapa4 años en adelante.";
    echo '<br>';
    echo '<br>';
      ...
      if ($primera == 11 || $primera == 22) {
       ...
       switch ($respuestaPrimera) {
        ...
        case '1':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, está regida bajo la vibración del número 1, lo que te dará la posibilidad de liderar. Ya que poseés capacidades ejecutivas, tendrás oportunidad de ser individualista en relación al pensamiento y a la acción. Esta etapa a menudo, te obliga a poner los pies sobre la tierra y a confiar en tu propio talento para triunfar, no en el talento de los demás. Las etapas con vibración 1, son periodos altamente activos aunque encontrándose en la primera etapa, podría ser un periodo difícil, pues se es aún demasiado joven para aprovechar todo este potencial, y por el contrario se probaría sensación de soledad, buscando solamente destacarte para lograr atraer la atención y la aprobación de los demás, quedando sola en la búsqueda del reconocimiento afectivo a través de tus acciones. Las etapas 1 son siempre periodos activos, como también llenos de posibilidades de cambio, para quien decida aprovecharlas en toda su magnitud';
            break;
        ...
        case '3':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, será un momento excelente para desarrollar tu capacidad creativa, para abrirte al mundo de las artes y la autoexpresión. Tendrás ocasión de escribir, pintar, diseñar, decorar, o también para el mundo del espectáculo. Es un excelente período para atraer el dinero con menos dificultad. Cuando el 3 rige la 1° etapa, pueden desperdiciarse tus ventajas, porque la tendencia será a la dispersión, como también comenzar muchas cosas sin terminarlas, sin tener la madurez necesaria para aprovechar su influencia.';
            break;
        
        case '4':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, al estar regida por la vibración del número 4, será un periodo de establecer buenas bases para el futuro. Se te exigirá trabajar arduo y constante, manejándote de manera práctica. Será un periodo adecuado para ahorrar y acumular reservas financieras para necesidades futuras. Es una etapa para mantener el orden y el progreso, clara visión de los objetivos, manteniendo la dedicación y la constancia para alcanzar los mismos. Es un período bienvenido, dado que brinda la oportunidad de poner en práctica tus ideas. Al aparecer en esta primera etapa la vibración numérica 4, establece que será una fase que demandará esfuerzo en el hogar, quizás te veas obligada a trabajar precozmente para ganarte la vida.';
            break;

        case '5':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, será un periodo de plena libertad, debiéndose desechar lo viejo para dar paso a lo nuevo, aceptando los cambios. Experimentarás inquietud e incertidumbre en varios momentos. No es un período para quedarse en casa o descansar a mirar la vida desde una ventana. Este número exige versatilidad, actividad, vida pública desapego, entonces se convertirá en un tiempo de avance y progreso. Suele suceder que al llegar una etapa regida por un número 5, lleva a que la persona haga cambios profundos en su vida, alterando el orden preestablecido, pero aceptando estos cambios positivamente, volverás a la estabilidad ya que evitarás que el dinero fluctúe entre la escasez y la abundancia. Existe aqui una adaptación a nuevos amigos, perdiendo gran parte de tu círculo de acción anterior. Evitá actuar por impulsos.';
            break;

        case '6':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, al estar regida por la vibración del número 6, refiere a muchos deberes y responsabilidades en el hogar, podés quedar al cuidado de niños, parientes y bienes. Será un momento útil para cultivar amor, formar una familia y brindarte con buena voluntad a los demás. También estar al servicio de la comunidad. Esta etapa no debe ser solo de intereses personales, ni para tu círculo íntimo; la felicidad la encontrarás en el dar. 
            El número que rige esta etapa nos cuenta que encontrarás el amor y protección a través de la familia (si elegís ese camino). Si se piensa en la solidez del vínculo amoroso (convivencia, casamiento, etc.) esta época será propicia para realizarlo, habrá mucho movimiento energético afectivo que cubrirá ese encuentro.';
            break;

        case '7':
            echo 'En tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, probarás un interés en el campo científico y educativo, tal vez hasta especializándote. Será esta etapa un buen momento para estudiar disciplinas alternativas u ocultas de la vida. Sería bueno para vos interesarte fundamentalmente por el progreso espiritual y menos por el triunfo material. Te verás introspectiva, lo que te llevará a probar un cambio interior, planteos y replanteos de lo vivido hasta este momento. Si no transitás este periodo de acuerdo a una vibración positiva y teniendo en cuenta todo lo dicho anteriormente en relación a tu plan de vida, tu destino y aquello que deberías potenciar y trabajar, tu tendencia será al mal humor, aislamiento, falta de comunicación, emotividad reprimida, causándote problemas con tu entorno familiar y relacional, falta de dinero, de reflexión y análisis, dispersión y poca atención al detalle. En cambio sí realizás en esta etapa un proceso evolutivo y de crecimiento personal, contemplando aquello que se te muestra, te elevarás, desarrollando capacidad de comprensión del significado de la vida, el conocimiento y la habilidad, esto te traerá plenitud y experticia. La clave de este período es cultivar la paciencia y comprensión.';
            break;
        
        case '8':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, será un excelente tiempo financiero, pudiendo obtener un lugar de privilegio, mando y autoridad. Etapa en la que te le pedirá y ofrecerá la oportunidad de ser dueña de tu propio emprendimiento, tendrás que adquirir fuerza, valor, poner ambición y esfuerzo constante. En esta etapa no se tolera la pereza, ni la falta de ambición. Analizar bien a las personas antes de confiar en ellas pues serás proclive a equivocarte en este sentido.';
            break;

        case '9':
            echo 'Tu primera etapa desde el nacimiento hasta los ' . $etapa1 . ' años, será un periodo de realización en el campo espiritual, debés transitar esta etapa despojada de toda ambición material, no tendrás que pretender ni amores, ni bienes personales, sino apuntar únicamente a ayudar a los demás a que logren sus objetivos alegrándote de corazón por ello, sin esperar agradecimiento. Es un periodo de prueba en la entrega, ya que se espera mucha compasión, tolerancia y dedicación. Si te tornaras resentida o egoísta será un tiempo de desdicha. Al estar éste número en la primera etapa, pueden experimentarse pérdidas de manera prematura. Si se vive como se te ha pedido (en relación a tu deseo del alma y tu destino) te colmarás de positividad; de no ser así, puede que esta etapa se lleve todo, abarca amores y posesiones. La etapa 9 es una de las más rigurosas en cuanto a exigir que se viva según el mandato del número.';
            break;
    }
      }
      ...
      if ($segunda == 11 || $segunda == 22) {
        ...
        case '11':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, será un periodo de oportunidad de ser notable y aparecer en público. Muy buen periodo para la expansión espiritual. Podría vivirse bajo gran tensión nerviosa si no se apunta lo suficientemente alto, elevándote en espíritu, trabajando y potenciando tus dones y cualidades; dejando de lado las ataduras vulgares del común de la gente. Por lo general esta etapa conduce a la separación de la pareja, o en una nueva manera de vincularse; por lo general se relaciona a una ruptura. Puede que seas inducida a revelar capacidad inventiva o tendencias espirituales; esto habla de una nueva manera de verte a vos misma y al mundo que te rodea.';
            break;
       ...
       switch ($respuestaSegunda) {
        ...
        case '1':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, está regida bajo la vibración del número 1, lo que te dará la posibilidad de liderar. Ya que poseés capacidades ejecutivas, tendrás oportunidad de ser individualista en relación al pensamiento y a la acción. Esta etapa a menudo, te obliga a poner los pies sobre la tierra y a confiar en tu propio talento para triunfar, no en el talento de los demás. Las etapas con vibración 1, son periodos altamente activos y llenos de posibilidades de cambio para quien decida aprovecharlas en su completa magnitud.';
            break;
        ...
        case '3':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, será un momento excelente para desarrollar tu capacidad creativa, para abrirte al mundo de las artes y la autoexpresión. Tendrás ocasión de escribir, pintar, diseñar, decorar, o también para el mundo del espectáculo. Es un excelente período para atraer el dinero con menos dificultad. Al estar en una etapa más avanzada de tu vida podés aprovechar tu experiencia para concretar; aunque también será necesario que prestes atención a no abrir demasiado el abanico de posibilidades, es decir de comenzar múltiples actividades, ya que esto puede llevar a una tendencia a la dispersión, es necesario entonces, concentrar tu dedicación en un rumbo cierto.';
            break;
        
        case '4':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, al estar regida por la vibración del número 4, será un periodo de establecer buenas bases para el futuro. Se te exigirá trabajar arduo y constante, manejándote de manera práctica. Será un periodo adecuado para ahorrar y acumular reservas financieras para necesidades futuras. Es una etapa para mantener el orden y el progreso, clara visión de los objetivos, manteniendo la dedicación y la constancia para alcanzar los mismos. Es un período bienvenido, dado que brinda la oportunidad de poner en práctica tus ideas.';
            break;

        case '5':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, será un periodo de plena libertad, debiéndose desechar lo viejo para dar paso a lo nuevo, aceptando los cambios. Experimentarás inquietud e incertidumbre en varios momentos. No es un período para quedarse en casa o descansar a mirar la vida desde una ventana. Este número exige versatilidad, actividad, vida pública desapego, entonces se convertirá en un tiempo de avance y progreso. Suele suceder que al llegar una etapa regida por un número 5, lleva a que la persona haga cambios profundos en su vida, alterando el orden preestablecido, pero aceptando estos cambios positivamente, volverás a la estabilidad ya que evitarás que el dinero fluctúe entre la escasez y la abundancia. Existe aqui una adaptación a nuevos amigos, perdiendo gran parte de tu círculo de acción anterior. Evitá actuar por impulsos.';
            break;

        case '6':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, al estar regida por la vibración del número 6, refiere a muchos deberes y responsabilidades en el hogar, podés quedar al cuidado de niños, parientes y bienes. Será un momento útil para cultivar amor, formar una familia y brindarte con buena voluntad a los demás. También estar al servicio de la comunidad. Esta etapa no debe ser solo de intereses personales, ni para tu círculo íntimo; la felicidad la encontrarás en el dar. El número que rige esta etapa nos cuenta que encontrarás el amor y protección a través de la familia. Si se piensa en la solidez del vínculo amoroso (convivencia, casamiento, etc.) esta época será propicia para realizarlo, también para ampliar ese amor en el proyecto de la maternidad; habrá mucho movimiento energético afectivo que cubrirá ese encuentro.';
            break;

        case '7':
            echo 'En la segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, probarás un interés en el campo científico y educativo, tal vez hasta especializándote. Será esta etapa un buen momento para estudiar disciplinas alternativas u ocultas de la vida. Sería bueno para vos interesarte fundamentalmente por el progreso espiritual y menos por el triunfo material. Te verás introspectiva, lo que te llevará a probar un cambio interior, planteos y replanteos de lo vivido hasta este momento. Si no transitás este periodo de acuerdo a una vibración positiva y teniendo en cuenta todo lo dicho anteriormente en relación a tu plan de vida, tu destino y aquello que deberías potenciar y trabajar, tu tendencia será al mal humor, aislamiento, falta de comunicación, emotividad reprimida, causándote problemas con tu entorno familiar y relacional, falta de dinero, de reflexión y análisis, dispersión y poca atención al detalle. En cambio sí realizás en esta etapa un proceso evolutivo y de crecimiento personal, contemplando aquello que se te muestra, te elevarás, desarrollando capacidad de comprensión del significado de la vida, el conocimiento y la habilidad, esto te traerá plenitud y experticia. La clave de este período es cultivar la paciencia y comprensión.';
            break;
        
        case '8':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, será un excelente tiempo financiero, pudiendo obtener un lugar de privilegio, mando y autoridad. Etapa en la que te le pedirá y ofrecerá la oportunidad de ser dueña de tu propio emprendimiento, tendrás que adquirir fuerza, valor, poner ambición y esfuerzo constante. En esta etapa no se tolera la pereza, ni la falta de ambición. Analizar bien a las personas antes de confiar en ellas pues serás proclive a equivocarte en este sentido.';
            break;

        case '9':
            echo 'La segunda etapa desde los ' . $etapa2 . ' años hasta los ' . $finEtapa2 . ' años, será un periodo de realización en el campo espiritual, debes transitar esta etapa despojada de toda ambición material, no tendrás que pretender ni amores, ni bienes personales, sino apuntar únicamente a ayudar a los demás a que logren sus objetivos alegrándote de corazón por ello, sin esperar agradecimiento. Es un periodo de prueba en la entrega, ya que se espera mucha compasión, tolerancia y dedicación. Si te tornaras resentida o egoísta será un tiempo de desdicha.Encontrandose este número en el segundo período implica que, durante esta etapa, se recogerán experiencias emotivas fuertes. Si se vive como se te ha pedido (en relación a tu deseo del alma y tu destino) te colmarás de positividad; de no ser así, puede que esta etapa se lleve todo, abarca amores y posesiones. La etapa 9 es una de las más rigurosas en cuanto a exigir que se viva según el mandato del número.';
            break;
    }
      }
    ...
    //    var_dump($terceraUno);
       ...
       $terceraDos = $primera + $respuestaSegunda; //20
    //    var_dump($terceraDos);
      
       $terceraTres = $respuestaPrimera + $segunda; //20
    //    var_dump($terceraTres);
       
       $terceraCuatro = $respuestaPrimera + $respuestaSegunda; //11
    ...
    //    if ($terceraDos == 11 || $terceraDos == 22){
    //     echo 'esto es tercerados' . $terceraDos;
    ...
    // if ($terceraTres == 11 || $terceraTres == 22){
    //     echo 'esto es terceratres' . $terceraTres;
    ...
    // if ($terceraCuatro == 11 || $terceraCuatro == 22){
    //     echo 'esto es terceracuatro' . $terceraCuatro;
    //     echo '<br>';

    //     switch ($terceraCuatro) {
    ...
    // }
      ...
      if ($tercera == 11 || $tercera == 22) {
       ...
       $respuestaTercera = ($tercera % 9 ?: 9);
        ...
        case '1':
            echo 'La tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, está regida bajo la vibración del número 1, lo que te dará la posibilidad de liderar. Ya que poseés capacidades ejecutivas, tendrás oportunidad de ser individualista en relación al pensamiento y a la acción. Esta etapa a menudo, te obliga a poner los pies sobre la tierra y a confiar en tu propio talento para triunfar, no en el talento de los demás. Las etapas con vibración 1, son periodos altamente activos y llenos de posibilidades de cambio para quien decida aprovecharlas en su completa magnitud.';
            break;
        ...
        case '3':
            echo 'La tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, será un momento excelente para desarrollar tu capacidad creativa, para abrirte al mundo de las artes y la autoexpresión. Tendrás ocasión de escribir, pintar, diseñar, decorar, o también para el mundo del espectáculo. Es un excelente período para atraer el dinero con menos dificultad. Al estar en una etapa más avanzada de tu vida podés aprovechar tu experiencia para concretar; aunque también será necesario que prestes atención a no abrir demasiado el abanico de posibilidades, es decir de comenzar múltiples actividades, ya que esto puede llevar a una tendencia a la dispersión, es necesario entonces, concentrar tu dedicación en un rumbo cierto.';
            break;
        
        case '4':
            echo 'La tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, al estar regida por la vibración del número 4, será un periodo de establecer buenas bases para el futuro. Se te exigirá trabajar arduo y constante, manejándote de manera práctica. Será un periodo adecuado para ahorrar y acumular reservas financieras para necesidades futuras. Es una etapa para mantener el orden y el progreso, clara visión de los objetivos, manteniendo la dedicación y la constancia para alcanzar los mismos. Es un período bienvenido, dado que brinda la oportunidad de poner en práctica tus ideas.';
            break;

        case '5':
            echo 'La tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, será un periodo de plena libertad, debiéndose desechar lo viejo para dar paso a lo nuevo, aceptando los cambios. Experimentarás inquietud e incertidumbre en varios momentos. No es un período para quedarse en casa o descansar a mirar la vida desde una ventana. Este número exige versatilidad, actividad, vida pública desapego, entonces se convertirá en un tiempo de avance y progreso. Suele suceder que al llegar una etapa regida por un número 5, lleva a que la persona haga cambios profundos en su vida, alterando el orden preestablecido, pero aceptando estos cambios positivamente, volverás a la estabilidad ya que evitarás que el dinero fluctúe entre la escasez y la abundancia. Existe aqui una adaptación a nuevos amigos, perdiendo gran parte de tu círculo de acción anterior. Evitá actuar por impulsos.';
            break;
        ...
        case '7':
            echo 'En la tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, probarás un interés en el campo científico y educativo, tal vez hasta especializándote. Será esta etapa un buen momento para estudiar disciplinas alternativas u ocultas de la vida. Sería bueno para vos interesarte fundamentalmente por el progreso espiritual y menos por el triunfo material. Te verás introspectiva, lo que te llevará a probar un cambio interior, planteos y replanteos de lo vivido hasta este momento. Si no transitás este periodo de acuerdo a una vibración positiva y teniendo en cuenta todo lo dicho anteriormente en relación a tu plan de vida, tu destino y aquello que deberías potenciar y trabajar, tu tendencia será al mal humor, aislamiento, falta de comunicación, emotividad reprimida, causándote problemas con tu entorno familiar y relacional, falta de dinero, de reflexión y análisis, dispersión y poca atención al detalle. En cambio sí realizás en esta etapa un proceso evolutivo y de crecimiento personal, contemplando aquello que se te muestra, te elevarás, desarrollando capacidad de comprensión del significado de la vida, el conocimiento y la habilidad, esto te traerá plenitud y experticia. La clave de este período es cultivar la paciencia y comprensión.';
            break;
        
        case '8':
            echo 'La tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, será un excelente tiempo financiero, pudiendo obtener un lugar de privilegio, mando y autoridad. Etapa en la que te le pedirá y ofrecerá la oportunidad de ser dueña de tu propio emprendimiento, tendrás que adquirir fuerza, valor, poner ambición y esfuerzo constante. En esta etapa no se tolera la pereza, ni la falta de ambición. Analizar bien a las personas antes de confiar en ellas pues serás proclive a equivocarte en este sentido.';
            break;

        case '9':
            echo 'La tercera etapa desde desde los ' . $inicioEtapa3 . ' años hasta los ' . $finEtapa3 . ' años, será un periodo que, al estar regido por el número 9, movilizará la energía de realización en el campo espiritual, debes transitar esta etapa despojada de toda ambición material, no tendrás que pretender ni amores, ni bienes personales, sino apuntar únicamente a ayudar a los demás a que logren sus objetivos alegrándote de corazón por ello, sin esperar agradecimiento. Es un periodo de prueba en la entrega, ya que se espera mucha compasión, tolerancia y dedicación. Si te tornaras resentida o egoísta será un tiempo de desdicha. Encontrándose este número en el tercer período implica que, durante esta etapa, se recogerán experiencias emotivas fuertes. Si se vive como se te ha pedido (en relación a tu deseo del alma y tu destino) te colmarás de positividad; de no ser así, puede que esta etapa se lleve todo, abarca amores y posesiones. La etapa 9 es una de las más rigurosas en cuanto a exigir que se viva según el mandato del número.';
            break;
    }
      }
    ...
    if ($cuarta == 11 || $cuarta == 22) {
        ...
        case '11':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, será un periodo de oportunidad de ser notable y aparecer en público. Muy buen periodo para la expansión espiritual. Podría vivirse bajo gran tensión nerviosa si no se apunta lo suficientemente alto, elevándote en espíritu, trabajando y potenciando tus dones y cualidades; dejando de lado las ataduras vulgares del común de la gente. Por lo general esta etapa conduce a la separación de la pareja, o en una nueva manera de vincularse; por lo general se relaciona a una ruptura. Puede que seas inducida a revelar capacidad inventiva o tendencias espirituales; esto habla de una nueva manera de verte a vos misma y al mundo que te rodea.';
            break;
       ...
       $respuestaCuarta = ($cuarta % 9 ?: 9);
        ...
        case '1':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, está regida bajo la vibración del número 1, lo que te dará la posibilidad de liderar. Ya que poseés capacidades ejecutivas, tendrás oportunidad de ser individualista en relación al pensamiento y a la acción. Esta etapa a menudo, te obliga a poner los pies sobre la tierra y a confiar en tu propio talento para triunfar, no en el talento de los demás. Las etapas con vibración 1, son periodos altamente activos y llenos de posibilidades de cambio para quien decida aprovecharlas en su completa magnitud.';
            break;
        ...
        case '3':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, será un momento excelente para desarrollar tu capacidad creativa, para abrirte al mundo de las artes y la autoexpresión. Tendrás ocasión de escribir, pintar, diseñar, decorar, o también para el mundo del espectáculo. Es un excelente período para atraer el dinero con menos dificultad. Al estar en una etapa más avanzada de tu vida podés aprovechar tu experiencia para concretar; aunque también será necesario que prestes atención a no abrir demasiado el abanico de posibilidades, es decir de comenzar múltiples actividades, ya que esto puede llevar a una tendencia a la dispersión, es necesario entonces, concentrar tu dedicación en un rumbo cierto.';
            break;
        
        case '4':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, al estar regida por la vibración del número 4, será un periodo de establecer buenas bases para el futuro. Se te exigirá trabajar arduo y constante, manejándote de manera práctica. Será un periodo adecuado para ahorrar y acumular reservas financieras para necesidades futuras. Es una etapa para mantener el orden y el progreso, clara visión de los objetivos, manteniendo la dedicación y la constancia para alcanzar los mismos. Es un período bienvenido, dado que brinda la oportunidad de poner en práctica tus ideas. La familia puede ser de gran responsabilidad bajo este número, fundamentalmente cuando representa la cuarta etapa. En muchos casos, al estar en cuarto lugar conduce a labores cívicas o de gobierno.';
            break;

        case '5':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, será un periodo de plena libertad, debiéndose desechar lo viejo para dar paso a lo nuevo, aceptando los cambios. Experimentarás inquietud e incertidumbre en varios momentos. No es un período para quedarse en casa o descansar a mirar la vida desde una ventana. Este número exige versatilidad, actividad, vida pública desapego, entonces se convertirá en un tiempo de avance y progreso. Suele suceder que al llegar una etapa regida por un número 5, lleva a que la persona haga cambios profundos en su vida, alterando el orden preestablecido, pero aceptando estos cambios positivamente, volverás a la estabilidad ya que evitarás que el dinero fluctúe entre la escasez y la abundancia. Existe aqui una adaptación a nuevos amigos, perdiendo gran parte de tu círculo de acción anterior. Evitá actuar por impulsos.';
            break;

        case '6':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, al estar regida por la vibración del número 6, refiere a muchos deberes y responsabilidades en el hogar, podés quedar al cuidado de niños, parientes y bienes. Será un momento útil para cultivar amor, formar una familia y brindarte con buena voluntad a los demás. También estar al servicio de la comunidad. Esta etapa no debe ser solo de intereses personales, ni para tu círculo íntimo; la felicidad la encontrarás en el dar. 
            El número que rige esta etapa nos cuenta que encontrarás el amor y protección a través de la familia (si elegís ese camino). Si se piensa en la solidez del vínculo amoroso (convivencia, casamiento, etc.) esta época será propicia para realizarlo, habrá mucho movimiento energético afectivo que cubrirá ese encuentro.
            Encontrándose este número en el último pináculo, promueve a la recompensa de los esfuerzos que hayas realizado durante toda tu vida, esto te otorgará tranquilidad financiera y felicidad.';
            break;

        case '7':
            echo 'En la cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, probarás un interés en el campo científico y educativo, tal vez hasta especializándote. Será esta etapa un buen momento para estudiar disciplinas alternativas u ocultas de la vida. Sería bueno para vos interesarte fundamentalmente por el progreso espiritual y menos por el triunfo material. Te verás introspectiva, lo que te llevará a probar un cambio interior, planteos y replanteos de lo vivido hasta este momento. Si no transitás este periodo de acuerdo a una vibración positiva y teniendo en cuenta todo lo dicho anteriormente en relación a tu plan de vida, tu destino y aquello que deberías potenciar y trabajar, tu tendencia será al mal humor, aislamiento, falta de comunicación, emotividad reprimida, causándote problemas con tu entorno familiar y relacional, falta de dinero, de reflexión y análisis, dispersión y poca atención al detalle. En cambio sí realizás en esta etapa un proceso evolutivo y de crecimiento personal, contemplando aquello que se te muestra, te elevarás, desarrollando capacidad de comprensión del significado de la vida, el conocimiento y la habilidad, esto te traerá plenitud y experticia. La clave de este período es cultivar la paciencia y comprensión.';
            break;
        
        case '8':
            echo 'La cuarta etapa desde los ' . $inicioEtapa4 . ' años en adelante, será un excelente tiempo financiero, pudiendo obtener un lugar de privilegio, mando y autoridad. Etapa en la que te le pedirá y ofrecerá la oportunidad de ser dueña de tu propio emprendimiento, tendrás que adquirir fuerza, valor, poner ambición y esfuerzo constante. En esta etapa no se tolera la pereza, ni la falta de ambición. Analizar bien a las personas antes de confiar en ellas pues serás proclive a equivocarte en este sentido.';
            break;
    ...
    echo 'Desafíos';
    echo '<br>';
    echo 'El resumen de desafíos a tener en cuenta a lo largo de tu vida, no implican etapas, sino los desafíos más importantes; en tu informe se presentan aquellos desafíos fundamentales, en los que debes enfocarte, sobre todo el primero que se presenta, que, en tu informe resulta ser uno de los principales.';

    //////////////  PRIMER DESAFIO  //////////////
    $primerDesa= a($dia) - b($mes);
    $primerDesa = $primerDesa >= 0 ? $primerDesa : $primerDesa * -1;

    //////////////  SEGUNDO DESAFIO  //////////////
    $segundoDesa = a($dia) - c($año);
    $segundoDesa = $segundoDesa >= 0 ? $segundoDesa : $segundoDesa * -1;
    
    //////////////  TERCER DESAFIO  //////////////
    $tercerDesa = $primerDesa - $segundoDesa;
    $tercerDesa = $tercerDesa >= 0 ? $tercerDesa : $tercerDesa * -1;
    
    ////////////// CUARTO DESAFIO  //////////////
    $cuartoDesa = b($mes) - c($año);
    $cuartoDesa = $cuartoDesa >= 0 ? $cuartoDesa : $cuartoDesa * -1;
    ...
    switch ($primerDesa) {
        ...
        case '2':
            echo 'Como desafío el aprendizaje está en el campo emocional y la dificultad para poder acceder al mismo. La vida te llevaría a situaciones en las que debes aprender a asociarte y a relacionarte con los otros sin depender ni esperar siempre la aprobación ajena. El gran aprendizaje está en encontrar el equilibrio interior sin reprimir tus emociones o dejarte dominar por ellas. Hay una tendencia a subestimarte y entonces, a deprimirte boicoteando las propias capacidades y talentos.';
            break;

        case '3':
            echo 'El desafío que se te presenta está relacionado con la necesidad de desarrollar tus capacidades expresivas- creativas, que seguramente han sido desmerecidas o dejadas de lado. Cultivar un vínculo profundo y consecuente con el conocimiento desarrollando la capacidad de transmitirlo a través de conferencias, oratoria, clases etc. Cultivar el vínculo con grupos desde ese lugar de trasmisión y creatividad; desde lo social, ayudará a quienes te rodean; tu saber resultará beneficiosos para ellos, tanto como para vos. El desafío será el de cuidar que la expansión no se traduzca en dispersión y falta de profundidad.';
            break;
        
        case '4':
            echo 'Como desafío es un tiempo para abocarse al trabajo y la disciplina que éste enseña, desarrollando una actitud práctica, sensata y moderada en la vida. La fuerza de voluntad y la firmeza en los objetivos te permitirán salir de situaciones estancadas y de una mirada temerosa y rutinaria de la vida. Flexibilizar los pensamientos, dejar entrar nuevas miradas te llevaran a un tiempo más creativo y divertido. Cuidar el patrimonio, incluido el cuerpo es parte del aprendizaje.';
            break;

        case '5':
            echo 'Como desafío es tiempo de comprender la diferencia entre libertad y libertinaje. Podes vivir muchas situaciones que te llevan al límite de la rebeldía y de aventuras riesgosas. Posees facilidad para romper ataduras a temprana edad y encontrarte utilizando erróneamente tus cualidades expresivas, ingeniosas y tu gran habilidad mental.
            De ser así, hay una gran tendencia a no pensar dos veces antes de tomar decisiones y no proyectar en el futuro, perdiendo muchas veces los afectos y relaciones en una búsqueda incesante de emociones que te saquen de la rutina; muchas veces cayendo en situaciones riesgosas, exposiciones, adicciones y actitudes de descontrol y destrucción.';
            break;

        case '6':
            echo 'Este desafío está relacionado con la necesidad de encontrar una mirada afectiva y comprensiva hacia los demás, especialmente tu familia cercana. Cultivar el sentido del servicio sin juzgar y bajando el nivel de perfección que te caracteriza. Te encontrarás en situaciones exigida de socorrer a enfermos, de atender a personas que se acercan buscando consuelo y ayuda, ya sea material, afectiva, social etc. Es un tiempo para ser tolerante y receptiva con los demás y con vos misma, despertando ese anhelo interior de totalidad que es el centro de la condición humana.';
            break;

        case '7':
            echo 'Como desafío vivirás seguramente situaciones que te sobrepasan y ante las cuales no podrás oponer argumentos concretos y materiales. Las condiciones no serán las acostumbradas, pero hay necesidad de dejarte llevar, aceptar y fluir con ellas en lugar de oponerte. Será desafío salir del aislamiento, de encerrarte y vivir enigmáticamente. La vida seguramente te mostrará otra dimensión y necesitarás vivir en un ambiente de paz, tranquilidad y comunión con la profundidad de tu alma. Aceptar la realidad y no fantasear o imaginarla es un buen consejo.';
            break;
    ...
    switch ($numPredi1) {
        ...
        case 1:
            echo 'Tu número del año personal en 2022: 1
            <br>
            Este año posee una vibración relacionada con el inicio de un nuevo ciclo de 9 años; por lo que nos habla de iniciativa, nuevas actividades a largo plazo. Impulso, decisión, nuevas oportunidades y proyectos.';
            break;
        
        case 2:
            echo 'Tu número del año personal en 2022: 2
            <br>
            Este año posee una vibración que invita a la consolidación de contactos, sociedades y alianzas de todo tipo. Te será necesario armarte de paciencia y discreción, sin caer en dualidades.';
            break;

        case 3:
            echo '
            Tu número del año personal en 2022: 3
            <br>
            Este año posee una vibración relacionada con la sociabilidad, auto-expresión, creatividad, nuevos contactos favorables para activar y divulgar diferentes actividades.';
            break;

        case 4:
            echo 'Tu número del año personal en 2022: 4
            <br>
            Este año posee una vibración que está relacionada con la producción, trabajo, concreción, la necesidad de llevar a cabo planes pasados y sentar bases para el futuro. Salud y finanzas en la mira.';
            break;

        case 5:
            echo 'Tu número del año personal en 2022: 5
            <br>
            Este año posee una vibración que está relacionada con el movimiento, cambios, viajes mudanzas, imprevistos que invitan enfrentarse a través de los la flexibilidad y libertad para no aferrarse a nada.';
            break;
        
        case 6:
            echo 'Tu número del año personal en 2022: 6
            <br>
            Este año posee una vibración que está relacionada al hogar, la familia y los eventos domésticos. Mudanzas, nacimientos, separaciones afectivas, uniones.';
            break;
        
        case 7:
            echo 'Tu número del año personal en 2022: 7
            <br>
            Este año posee una vibración que está relacionada con la reflexión, investigación, estudios y enseñanza. Se necesita una pausa para crecer internamente, no será un año de crecimiento financiero.';
            break;

        case 8:
            echo 'Tu número del año personal en 2022: 8
            <br>
            Este año posee una vibración que está relacionada al favorecimiento de las inversiones en bienes y el comercio en general. Es año de cosecha, de expansión económica, dependiendo de la siembra de los años anteriores.';
            break;

        case 9:
            echo 'Tu número del año personal en 2022: 9
            <br>
            Este año posee una vibración que está relacionada con un cierre del ciclo, desenlaces y conclusiones. Cambios y transiciones adecuados para ordenar el próximo ciclo.';
            break;

        case 11:
            echo 'Tu número del año personal en 2022: 11
            <br>
            Este año posee una vibración que favorece el idealismo, la inspiración y el liderazgo, con gran iluminación psíquica; cualidades que deben tenerse en cuenta para no quedar relegado a un ciclo 2 (es decir, sin caer en dualidades. El ciclo 2 invita a la consolidación, contactos, sociedades y alianzas de todo tipo. Son necesarias paciencia y discreción)';
            break;

        case 22:
            echo 'Tu número del año personal en 2022: 22
            <br>
            Este año posee una vibración que invita a trascender fronteras personales en todo sentido. Concretar grandes ideales a escala humanitaria, pero muchas veces suele quedar relegado a un 4.
            <br>
            Si este fuera el caso, la vibración 4 está relacionada con la producción, trabajo, concreción, la necesidad de llevar a cabo planes pasados y sentar bases para el futuro. Salud y finanzas en la mira.';
            break;
    }
    ...
    switch ($cuatri1) {
        ...
        case 1:
            ...
            <br>
            El secreto está en la concentración. Serás capaz de realizar milagros, tenes en tus manos el control de todas las cuestiones materiales. Canaliza tus pensamientos hacia áreas fértiles donde las energías de tu mente establezcan normas susceptibles de ser transmitidas a los niveles subliminales. Las reacciones subconscientes que provoques te aportarán los resultados que deseas. Te darás cuenta de que bajo el 1, solo tus propios deseos limitaran los resultados.
            <br>
            Un uso negativo de las energías del número uno puede impulsarte a tomar una actitud de terquedad que te hará seguir tu propio camino sin preocuparte de las consecuencias. Es productivo que le des rienda suelta a tu individualidad pero guíala con juicio. Bajo esta influencia no hay que dejarse dominar por la impulsividad. Traza sólo tus propios planos, ya que en este momento debes evitar toda asociación en un plano de igualdad. Tal vez conozcas a una persona que desempeñará un importante papel en tu futuro. Experimenta con lo nuevo y lo no probado. Mostrate independiente y resuelta y, sobre todo, tene el valor de actuar conforme a tus sueños.';
            break;
        ...
        case 3:
            ...
            <br>
            Emplea tiempo y dinero en mejorar tu aspecto personal, ya que en este momento tiene gran importancia como te ven los demás. Deberías introducirte en un buen hábito de alimentación saludable o asistir a un curso de yoga, con el fin de remodelar y fortalecer el cuerpo. Presta especial atención a la manera en que te vestís y renova tu guardarropa, desechando prendas deterioradas o pasadas de moda.
            <br>
            En este periodo, los negocios armonizan bien con el placer. Por lo tanto, introducite en los aspectos sociales de la vida. Las personas que conozca quedaran impresionadas con tus modales y tu facilidad de palabra, y algunas de ellas estarán en posición de ayudarte en tu carrera. De fiestas, unite a grupos, asistí a seminarios, encontrate con otros.
            <br>
            No te comprometas ahora con nada que te ate y te obstaculice en ningún sentido. Necesitas libertad y tiempo para cultivar la autoexpresión. Si siempre has deseado viajar, se te presenta la oportunidad. El 3 aporta grandes viajes, ofreciéndote la posibilidad de expansionarte en contacto con otras culturas y otros modos de vida. Ocupando ahora el centro de la escena y disfrutando de esta situación, te animara con el calor de la atención ajena a irradiar la alegría que experimentas, con lo que iluminara las vidas de aquellos con los que te halles en contacto. Presta atención a tus sueños, que pueden traerte mensajes pre cognoscitivo y disponete a aprovechar las posibles oportunidades. Te encontras en un periodo productivo en todas las áreas de la vida.
            <br>
            Los aspecto negativos del 3 conducen a una dispersión de las energías y a un exceso de auto indulgencia en todos los aspectos. La tendencia a hablar demasiado desemboca en la chismorrea y la duplicidad. La extravagancia termina en la disipación. Quienes se arriesgan con exceso acaban por sufrir alguna perdida. Los celos provocan la soledad. Los excesos en la comida y en la bebida y el uso inmoderado de las drogas suelen tener resultados desastrosos. Recordá que agotar los valiosos recursos de este periodo lleva a la disipación y transforma un suelo fértil en tierra devastada.
            <br>
            Hay un antiguo dicho: “Cuidado con lo que deseas, pues seguramente lo conseguirás”. Si se desea algo con suficiente intensidad, sin duda acabara por cumplirse. Y una vez ese algo convertido en realidad, puede que te des cuenta de que no lo quería en absoluto. Tus deseos pueden realizarse durante este periodo. Por consiguiente, te conviene tamizarlos. Asegurate de su rectitud y de su bondad, tanto en lo que a vos misma respecta, como en lo que se refiere a las demás personas implicadas en la cuestión, y luego disfruta de esta época feliz y productiva.';
            break;
        ...
        case 4:
            ...
            <br>
            El dinero y las finanzas ocupan gran parte de este ciclo, por lo cual debes mostrarte astuta y práctica en el plano económico. Al ser una etapa de orden y cálculos, será buen momento para realizar un presupuesto y pagar deudas en todos los niveles (materiales, físicos, mentales y espirituales). Tiempo ideal para ahorrar con vistas a esas vacaciones especiales o esa casa que deseas. Los puntos capitales de esta vibración consisten en la responsabilidad, el trabajo y la consumación. Desde el punto de vista financiero, ganarás en proporción directa a lo que arriesgues. El periodo está destinado a poner sólidos cimientos financieros físicos o mentales para tu vida. Se ampliarán tus negocios y relaciones temporales; pueden establecerse lasos de una amistad duradera.
            El estudio del terreno, la planificación y la construcción de una nueva casa, o bien la reestructuración y la reedificación de alguna ya construida constituyen propósitos muy probables bajo un 4. Tal vez se presenten obstáculos, pero si tenés el valor de luchar contra toda oposición, progresarás a grandes pasos.
            <br>
            La razón, reina sobre todo este período. El numero 4 simboliza una ventana por la cual observamos, por lo tanto, debes ejecutar tu clarividencia, penetración y sentido analítico. Dado que sos capaz de ver el meollo de cualquier situación, serás llamada a utilizar tu razón y tu capacidad de juicio, quizás dentro del sistema judicial, como jurado o como testigo en un proceso. Ahora, te serán revelados aspectos antes ocultos del pasado, hecho que te permitirá corregir los juicios erróneos formulados en épocas anteriores. Esto se debe a que el 4 significa la puerta de la oportunidad, a través de la cual entrara a una nueva vida.';
            break;
        ...
        case 5:
            ...
            <br>
            Tiempo perfecto para proporcionarte a vos misma o proporcionar algún provecho, ya que gozas de fluidez del lenguaje, de facilidad de expresión y comunicación con los demás. Conocerás gente nueva y no hallarás dificultades para hacerte amigos. Los negocios se combinan ahora con las actividades sociales, dando resultados satisfactorios. De tus experiencias y contactos con los demás, te beneficiaras de conocimientos, que se fijarán en tu subconsciente aumentando así tu comprensión.
            Constituye también un periodo en el cual disfrutarás de gran magnetismo a nivel sensual/sexual; encuentros amorosos rápidos e intensos. Un antiguo amor puede reaparecer. Grandes oportunidades de relacionarse con el sexo opuesto, alguno de estos vínculos quizás culmine en un affaire o en una relación a largo plazo. Se presentarán numerosas tentaciones que requerirán de gran autocontrol para tomar la decisión correcta.
            <br>
            A causa de tu intenso deseo de cambio, podes decidirte, o verte forzada, a cambiar de trabajo o de socios, a variar o modificar en grado considerable tu estilo de vida. A veces te parecerá que otras personas te obligan a moverte. Sin embargo, las situaciones se plantearán por tu propia necesidad de cambio. Aunque en ocasiones esa necesidad de cambio será puesta en marcha por otros, siempre estará motivada por tus energías subconscientes. Será productivo que puedas controlarte, canalizar tus energías de manera juiciosa y actuar con decisión.';
            break;
        ...
        case 6:
            ...
            <br>
            Podes en este periodo entablar fuertes lazos de amistad con alguien. Experimentas un gran sentido de la responsabilidad con respecto a otras personas, que te captaran así. En consecuencia, se volverán hacia vos en busca de apoyo, se refugiaran en tus brazos para llorar o acaso soliciten tu ayuda económica. Ciertas relaciones te resultarán gravosas y tendrás que hacerte cargo de personas ancianas. Debes aceptar esta situación de buena gana y, sobre todo, mantener la armonía. Dejas de lado por algún tiempo tus propias necesidades. Sin embargo, no admitas cargas innecesarias.
            <br>
            Este vibración estimula el sentido artístico que aplicará constructivamente para decorar y reformar tu casa. También tu conciencia social se manifiesta, por lo que entre tus actividades, se incluye la celebración de frecuentes fiestas en tu casa. Pone dicha casa en orden, lo mismo que tu casa física, el cuerpo; hace chequeos de rutina, acudí a clase de gimnasia para fortalecer y distender los músculos y, en general trata de mejorar tu salud.
            <br>
            Recordá que no debes cargar con responsabilidades innecesarias. Por lo tanto, cuando aceptes un compromiso, pensa siempre en su conclusión. Pone en práctica, en cambio, los viejos proyectos en los que llevas pensando desde hace tiempo. Medita a fondo cómo vencer los obstáculos que se te opongan. Puede ser este periodo de amor, de recompensas y de creación, sí que sabes conservar el equilibrio y la armonía. Hace tu hogar lo más atractivo posible y otros acudirán a él para reconfortarse con su calor.';
            break;
        ...
        case 7:
            ...
            <br>
            No trates de mejorar tus finanzas durante un periodo 7; no es tiempo apropiado para mostrarte impulsiva o para embarcarte en negocios. Este es un tiempo de perfeccionamiento físico y de cosecha de los ciclos previos, gracias a tus esfuerzos previos. Será propicio un paso mesurado, descansar y atender a los problemas menores. El abuso y el esfuerzo excesivo te causarán trastornos y enfermedades. Esas molestias te obligarán a frenar, de modo que podrás disponer de tiempo para reflexionar sobre vos misma y sobre lo que te propone la vida; esta es una de las cuestiones más importantes del presente ciclo. El número 7 rige en el cuerpo físico y las funciones corporales; por consiguiente, se activan ahora las fuerzas internas de tu cuerpo.
            <br>
            Las cuestiones se resuelven misteriosamente por sí solas, sin ninguna intervención de tu parte, espera y deja que el ciclo actúe a tu favor. Este es un momento propicio para realizar viajes.
            <br>
            En este ciclo se recomienda tener cuidado de firmar documentos o convenios legales; es aconsejable contemplar cada palabra y buscar las posibles trampas; cuando hayas explorado a fondo todos los aspectos, firma con confianza. No sentirás necesidad de contacto social durante esta temporada; preferirás permanecer sola o acompañada por personas que cultiven interés por lo espiritual. No intentes dominar tus impulsos internos, esto solo te aportaría problemas físicos y frustración; al contrario, dejate arrastrar por ellos y observalos actuar en lo más profundo de vos misma, a fin de descubrir las bellas facetas de tu verdadero yo interior, la joya perfecta.';
            break;
        ...
        case 8:
            ...
            <br>
            Mostrate eficiente, organizada y atenta a los resultados tangibles. Necesitarás energía y ambición para aceptar las oportunidades que se te ofrecen. Predomina en vos el impulso interior hacia las proezas físicas. No obstante, actuá con cautela. No permitas que la tensión de tu presente empeño agote tus energías. Personas poderosas acudirán en tu ayuda si se lo pedís.
            <br>
            A causa de las implicaciones Kármicas de este ciclo, tal vez recibas una herencia o un legado. Quizás hayas sembrado semillas de amor y de interés en alguien que, ahora, te dará a cambio recompensas materiales, dinero, propiedades o cualquier otra cosa de valor. Cuánto recibas será el resultado de tus propios esfuerzos del pasado.
            <br>
            Ayuda a quienes no operan en tu alto nivel de energía. En tu ascensión a la cumbre, no olvide a tus amigos ni a quienes te rodean. Prestales tu fuerza y tu seguridad, ya que, sin la menor duda, este ciclo 8 te revelara la absoluta necesidad de sembrar buenas semillas.';
            break;
        ...
        case 9:
            ...
            <br>
            Las amistades presentes se cimentaran y se harán más duraderas y recibirás regalos de sus amigos. Se trata de un periodo caritativo, en el que debes preocuparse sobre todo de los demás, hacer algo por ellos, como acción de gracias por las bendiciones que has recibido en esta vida. Un antiguo amigo o un viejo amor pueden reaparecer para un último encuentro, pero es posible que no se prolongue esta súbita renovación de los lazos que les unieron.
            <br>
            Dado que se trata de un ciclo final, cabe en él un cambio de trabajo o de residencia. Si te ves separada de las personas, las situaciones o los lugares en los que has vivido tanto tiempo, se debe a que ya no te servían para tu proceso de evolución.
            <br>
            Aprovecha los poderes creativos de la vibración 9 para desarrollar tus facultades artísticas. Se te ocurrirán ideas que darán producto en el futuro en un sentido que determinara el próximo ciclo numérico. No te dejes arrastrar por las emociones. Aferrarte al pasado, complacerte en lo que ya caducó solo produce descontento, frustración y depresión. Que sea una opción mirar hacia el futuro con alegría y gran expectación, la energía liberadora del presente ciclo te ha preparado para ello. Deja que la sabiduría que te proporcionan los acontecimientos del ciclo 9 inspire productivamente tus acciones en el porvenir.';
            break;
